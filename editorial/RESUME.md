...
- **Next: `film-and-media-studies` (phase 3, 15 remaining topics)** — character, genre, documentary, animation, representation, race-and-media, gender-and-media, media-industries, media-ownership, advertising, news-media, social-media, media-literacy, propaganda, media-criticism. Scaffold + source-map exist; 13/28 accepted.
