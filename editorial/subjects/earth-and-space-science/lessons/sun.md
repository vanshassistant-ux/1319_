...
The Sun is the star at the center of our solar system, holding about 99.8 percent of the system's mass. It is a ball of hot gas, mostly hydrogen and helium, that shines because its core fuses hydrogen into helium, releasing enormous energy. That energy works its way outward through the radiative and convective zones, then through the photosphere we see, the chromosphere, and the corona. Sunspots, flares, and coronal mass ejections are signs of magnetic activity that can reach across space and affect Earth.
...
- **Core:** The central region of the Sun, where temperatures reach about 15 million degrees Celsius and nuclear fusion generates the Sun's energy.
- **Radiative zone:** The layer around the core through which energy travels outward as photons that are repeatedly absorbed and re-emitted by dense plasma.
- **Convective zone:** The outermost layer of the Sun's interior, where hot plasma rises, cools, and sinks in circulating cells that carry energy to the surface.
- **Photosphere:** The thin visible layer of the Sun from which sunlight escapes into space; its temperature is about 5,500 degrees Celsius.
- **Chromosphere:** A reddish layer of the solar atmosphere just above the photosphere, a few thousand kilometers thick.
- **Corona:** The Sun's outer atmosphere, which extends far into space, is hotter than the photosphere, and feeds the solar wind.
- **Nuclear fusion:** The process in which lightweight atomic nuclei combine to form heavier ones, releasing energy; the Sun fuses hydrogen into helium this way.
- **Sunspot:** A cooler, darker-appearing region on the photosphere where the Sun's magnetic field is unusually strong.
- **Solar flare:** A sudden eruption on the Sun that releases a burst of radiation, including X-rays and ultraviolet light.
- **Coronal mass ejection:** A large bubble of solar plasma, mainly protons and electrons, hurled into space; it can disturb Earth's magnetic field.
...
- **Mistake:** The Sun is burning like a fire. **Correction:** The Sun's energy comes from nuclear fusion of hydrogen into helium in the core; chemical burning could not sustain the Sun's output for billions of years.
- **Mistake:** The photosphere is the hottest part of the Sun. **Correction:** The core is by far the hottest region, near 15 million degrees Celsius; the photosphere is a relatively cool 5,500 degrees Celsius, and the corona is hotter than the photosphere.
- **Mistake:** Sunspots are cold, dark holes in the Sun. **Correction:** Sunspots are cooler than their surroundings (about 3,800 K versus 5,800 K) but still extremely hot; they appear dark only in contrast.
- **Mistake:** Solar flares and coronal mass ejections are the same event. **Correction:** A flare is a burst of radiation; a CME is a bubble of plasma thrown into space, though the two often occur together.
- **Mistake:** The Sun must be one of the biggest, most unusual stars. **Correction:** The Sun is an average-sized star; stars up to 100 times larger are known, and billions of similar stars fill the Milky Way.

## Compare / Contrast

| A | B | Distinction |
| --- | --- | --- |
| Core | Photosphere | The core is the hottest region and the source of fusion energy; the photosphere is the relatively cool visible surface where light escapes. |
| Solar flare | Coronal mass ejection | A flare releases a burst of radiation; a CME ejects a bubble of plasma into space, and the two often happen together. |
| Radiative zone | Convective zone | In the radiative zone, energy travels as photons that are absorbed and re-emitted; in the convective zone, hot plasma rises and sinks, carrying energy by circulation. |
...
1. **Which part of the Sun is the visible surface we see as the Sun's disk?**
   - A. Photosphere
   - B. Core
   - C. Corona
   - D. Chromosphere
   - **Answer:** A. The photosphere is the thin layer where the Sun becomes opaque to light, so it is the visible surface we see; the core lies far below, and the chromosphere and corona are transparent outer layers.

2. **What process produces the Sun's energy?**
   - A. Chemical burning of hydrogen gas
   - B. Friction from the Sun's rotation
   - C. Nuclear fusion of hydrogen into helium in the core
   - D. Heat left over from the solar system's formation
   - **Answer:** C. The Sun's energy comes from nuclear fusion, in which hydrogen nuclei combine to form helium and release energy; chemical burning or leftover heat cannot explain the Sun's enormous, long-lived output.

3. **Why do sunspots appear dark?**
   - A. They are holes through which cooler space shows
   - B. They are cooler regions, so they glow less brightly than the surrounding photosphere
   - C. They are shadows cast by the corona
   - D. They contain no hydrogen
   - **Answer:** B. Sunspots are about 3,800 K at their centers, cooler than the roughly 5,800 K photosphere, so they emit less light and look dark only by contrast; they are not holes or shadows.

4. **A large cloud of solar plasma is heading toward Earth after a solar eruption. Which effect is most likely when it arrives a few days later?**
   - A. The Sun will temporarily stop fusing hydrogen
   - B. Earth's orbit will shrink measurably
   - C. The photosphere will cool permanently
   - D. Auroras may intensify and satellites or power grids may be disturbed
   - **Answer:** D. A coronal mass ejection reaching Earth disturbs the magnetic field and upper atmosphere, brightening auroras and threatening satellites, communications, and power systems — the effects studied as space weather.

5. **Which combination of facts best supports the statement that the Sun is a fairly ordinary star?**
   - A. It is a medium-sized ball of hydrogen and helium, and billions of similar stars exist in the Milky Way
   - B. It is the largest object in the solar system and contains 99.8 percent of its mass
   - C. Its core is the hottest known place in the universe
   - D. It is the only star observed to have sunspots and flares
   - **Answer:** A. The Sun's ordinariness follows from being a medium-sized hydrogen-helium star among billions of similar ones; being the largest object in our solar system is a local distinction, not evidence of being unusual as a star.

## Sources

- NASA, *Sun* (science.nasa.gov/sun/), read live 2026-08-21.
- NASA, *Sun: Facts* (science.nasa.gov/sun/facts/), read live 2026-08-21.
- OpenStax, *Astronomy 2e*, "15.1 The Structure and Composition of the Sun."
- OpenStax, *Astronomy 2e*, "15.3 Solar Activity above the Photosphere."
- OpenStax, *Astronomy 2e*, "15.4 Space Weather."
- OpenStax, *Astronomy 2e*, "16.2 Mass, Energy, and the Theory of Relativity."
...
- **Method:** Original EliExplains synthesis from NASA Sun pages and OpenStax Astronomy 2e (sections 15.1, 15.3, 15.4, 16.2); every quantitative figure checked against the cited sources. No source prose, diagrams, or tables reproduced.
