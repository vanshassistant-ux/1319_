...
A business is an organization that provides goods or services to customers in exchange for something of value — usually money. Goods are physical products, like the ceramic mug you buy at a market stall; services are activities, like the haircut you get on Saturday. Businesses exist because organizing production and exchange beats everyone doing everything alone. Most businesses aim for a profit; not-for-profit organizations pursue a mission instead. Behind every purchase sits a chain of businesses, each started as an idea.

## Why This Matters

Business is the basic unit of commerce, and you meet one almost every hour: the café that sells your coffee, the utility that keeps the lights on, the delivery service that brings a package to your door. Understanding what a business is — and what it is not — gives you a precise way to read the economy around you, from a receipt to a news story about a company's profits. It also builds the vocabulary every later topic in this subject stands on: ownership forms, entrepreneurship, marketing, operations, and finance all assume you can recognize a business when you see one. Whether you act as a customer, an employee, a founder, or a citizen, the same question opens every door: what value is being organized, produced, and exchanged?
...
- **business** — An organization that provides goods or services to customers in exchange for something of value, usually money; the working definition in this lesson comes from OpenStax Introduction to Business.
- **goods** — Tangible, physical products that a business manufactures or sells, such as furniture, running shoes, or a bag of coffee beans.
- **services** — Intangible activities or work that a business performs for a customer, such as a haircut, a taxi ride, or a music lesson.
- **customer** — A person or organization that buys goods or services from a business, supplying the revenue that keeps the business operating.
- **revenue** — The money a company receives from selling goods or providing services to its customers.
- **profit** — What remains after a business pays all of its costs; the surplus that for-profit businesses aim to earn.
- **loss** — The result when a company's costs are greater than its revenues, so nothing remains after expenses are paid.
- **not-for-profit organization** — An organization that exists to achieve a goal other than profit, such as feeding the hungry or preserving the environment; also called a nonprofit.
...
- **Assuming only stores and factories are businesses.** Any organization that provides goods or services to customers for value is a business — a freelance web designer, a plumber's one-person practice, and a food truck all qualify.
- **Treating revenue and profit as the same thing.** Revenue is all the money a business takes in from sales; profit is what remains after costs are paid. A business can have high revenue and still lose money.
- **Believing not-for-profit organizations never earn money.** Nonprofits earn revenue and pay staff and rent like any organization; the difference is that any surplus is reinvested in the mission rather than paid out to owners.
- **Assuming customers are always individual people.** Businesses also sell to other businesses and to governments — a parts supplier's customers are factories, and a software firm's customers may be banks or city agencies.
- **Thinking a good idea is the same thing as a business.** An idea needs an organization — people, resources, processes, and paying customers — to become a business; the same idea can thrive or fail depending on how it is organized.

## Compare / Contrast

- **goods versus services** — Goods are tangible physical products that can be made, stored, and inspected before purchase; services are intangible activities produced and consumed at the same moment, such as a haircut or a taxi ride.
- **for-profit business versus not-for-profit organization** — Both produce goods or services, earn revenue, and pay costs, but a for-profit business aims to pay surplus out to its owners, while a nonprofit reinvests any surplus in its mission.
- **revenue versus profit** — Revenue is the money received from customers for goods and services; profit is what is left after costs — revenue minus costs — and it can be positive, zero, or negative, which is a loss.
...
1. What combination captures what a business provides to its customers?
   ...
   - D. shares of stock and dividend payments

   **Answer: A.** OpenStax's working definition says a business is an organization that strives for a profit by providing goods and services desired by its customers. Tax refunds, court rulings, and stock dividends are not what customers buy from a typical business.

2. A bakery sells loaves of bread, while a dog-walking service sells walks. What is the clearest way to describe the difference between these two outputs?
   - A. The bakery's output is always more profitable than the walker's output.
   - B. The bakery sells to organizations, while the walker sells to individuals.
   - C. The bakery produces a tangible good, while the walker provides an intangible service.
   - D. The bakery needs customers, while the walker does not.

   **Answer: C.** Goods are tangible items that can be held and stored, like bread; services are intangible activities, like walking a dog. Profitability, customer type, and having customers at all do not capture the output difference.

3. Rosa charges families $40 for each tutoring session and spends $25 per session on materials and transport. What do the $40 and the $15 left over represent?
   - A. The $40 is profit and the $15 is revenue.
   - B. The $40 is a cost and the $15 is a loss.
   - C. The $40 is a grant and the $15 is a donation.
   - D. The $40 is revenue and the $15 is profit.

   **Answer: D.** Revenue is the money a business receives from customers, here $40 per session. Costs are $25, so the remaining $15 is profit — what is left after costs are paid.

4. A food bank collects donated groceries, pays its staff, and distributes food free to families. It is best described as a not-for-profit organization rather than a for-profit business because
   - A. it earns no revenue, since donations do not count as revenue.
   - B. its purpose is a mission, such as feeding families, rather than profit for owners — even though it has revenue and costs.
   - C. it is a government agency that is legally barred from earning money.
   - D. it has no costs, because staff work for free and the warehouse is free.

   **Answer: B.** Not-for-profit organizations exist to achieve a goal other than profit; they can still earn revenue and pay costs, but any surplus is reinvested in the mission. The other options misstate revenue, ownership, and costs.

5. Mina buys a ceramic mug from a market stall. The stall owner bought the mug from a studio potter, who buys clay from a supplier and fires the kiln with electricity from a utility company. What does this single purchase reveal?
   - A. One purchase sits at the end of a chain of businesses — supplier, potter, and stall — each converting inputs into outputs and exchanging them for payment.
   - B. Only the stall is a business, because the potter and the supplier make products rather than sell them.
   - C. Customers must always be individual people, never other organizations.
   - D. Reselling goods is the only way a business can earn a profit.

   **Answer: A.** Production runs in a chain: each organization converts inputs into outputs and sells to the next link, ending with the customer. The other options wrongly narrow what counts as a business, who customers can be, and how profit arises.

## Sources

- **OpenStax Introduction to Business, Section 1.1: The Nature of Business** — OpenStax, Rice University (CC BY 4.0). https://openstax.org/books/introduction-business/pages/1-1-the-nature-of-business
- **OpenStax Introduction to Business, Chapter 10: Production and Operations Management** — OpenStax, Rice University (CC BY 4.0). https://openstax.org/books/introduction-business/pages/10-1-production-and-operations-management-an-overview
...
- **Topic ID:** introduction-to-business:foundations:what-is-a-business
- **Subject / Unit / Slug:** introduction-to-business / foundations / what-is-a-business
- **Editorial Status:** READY_TO_PUBLISH
- **Researched:** 2026-08-21
- **Rights:** reference-only sources; OpenStax facts (CC BY 4.0) restated in original prose with attribution recorded; no source prose adapted
- **Provenance:** EliExplains original synthesis — working definition attributed to OpenStax Introduction to Business, goods/services distinction, profit-versus-mission distinction, customer roles, and the purpose-of-a-business framing verified against the cited sources; all examples original.
