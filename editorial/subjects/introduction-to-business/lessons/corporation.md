...
A corporation raises money by selling shares: it divides ownership into units and sells them to investors, and the investors' money becomes capital the business can use to grow. Because a share can be small, a company can collect modest amounts from many people, which is how ventures reach the scale of airlines and phone networks. The details of shares, markets, and valuation belong to the finance-basics lesson; here the mechanism is the point. Shares also define the public-private split. In a public corporation, shares are traded openly on markets, so anyone can buy in. In a private corporation, shares are held by a small group and are not offered to the public. That is the honest framing in one line: the corporation is the dominant form for big business, and the most complex to run.

## Key Vocabulary

- **Corporation** — A business that exists as its own legal entity, separate from its owners, able to own property, sign contracts, and be sued in its own name.
- **Legal entity** — A status under the law that lets an organization act like a person, holding property, making agreements, and facing lawsuits independent of its owners.
- **Limited liability** — A protection that caps what owners can lose at the money they invested, keeping their personal assets out of reach of the business's debts.
- **Shareholder** — A person or organization that owns part of a corporation by holding shares of its stock.
- **Share** — One unit of ownership in a corporation that can usually be bought, sold, or transferred.
- **Board of directors** — A group elected by shareholders that sets major goals, hires top officers, and oversees the corporation's operations and finances.
- **Dividend** — A portion of a corporation's profits paid out to its shareholders.
- **Public corporation** — A corporation whose shares are traded openly on markets, so anyone can buy them.
- **Private corporation** — A corporation whose shares are held by a small group of owners and are not offered for sale to the public.
- **Double taxation** — In the classic corporate model, the taxing of profits once at the corporate level and again when the profits are paid to shareholders as dividends.
...
- **Believing limited liability means owners can never lose money.** Owners can lose their entire investment, and liability protection does not cover personal wrongdoing or loans the owner personally guaranteed; it covers the corporation's business debts.
- **Assuming the board runs the business day to day.** The board oversees: it sets major goals and hires the top officers. Managers and officers run daily operations.
- **Assuming every corporation is a giant, publicly traded company.** Corporations range from small, privately held firms to multinationals; most are private, with shares held by a small group.
- **Treating one country's corporate rules as universal.** Formation, taxes, and reporting vary by jurisdiction; this lesson describes the general model, and the classic double-taxation pattern is one common version, not a universal law.

## Compare / Contrast

- **Shareholders** vs **Board of directors** — Shareholders own the corporation and elect the board; the board sets goals and hires officers. Ownership and oversight are separate jobs.
- **Public corporation** vs **Private corporation** — A public corporation's shares trade openly on markets for anyone to buy; a private corporation's shares stay with a small group and are not offered to the public.
- **Limited liability** vs **Personal liability** — With limited liability, owners risk only their investment; with personal liability, an owner's own assets can be taken to pay the business's debts.
...
1. **What is a corporation?**
   - A business that exists as its own legal entity, separate from its owners, able to own property and sign contracts in its own name
   - A business owned by one person who is personally responsible for all of its debts
   - An arrangement in which two or more owners share a business's profits and losses
   - A government office that licenses and inspects new businesses

   *Answer: A. The working definition, from OpenStax's Introduction to Business, is a legal entity separate from its owners. One-owner businesses, shared-profit arrangements, and licensing offices are different things.*

2. **Keisha incorporated her bicycle repair shop. The shop defaults on a $50,000 loan. Under limited liability, what is the most the lender can take from Keisha personally?**
   - Her savings account and her car, up to $50,000
   - Whatever portion of the debt she personally approved
   - Nothing beyond the money she invested in the business
   - Half the debt, because she owns half the shares

   *Answer: C. Limited liability caps owners' losses at their investment, so the lender can take the shop's assets but not Keisha's personal assets. The other options all reach into her personal finances.*

3. **Marta owns shares in a corporation whose board just hired a new chief executive. Which sentence correctly describes the board's job in a corporation?**
   - The board takes over the daily tasks of the chief executive's team
   - The board sets major goals, hires top officers, and oversees the corporation's operations and finances
   - Board members become personally liable for the corporation's debts
   - The board sells its own shares to raise money for the company

   *Answer: B. The board oversees: it sets major goals and policies, hires corporate officers, and monitors operations and finances. Daily tasks belong to managers, and board service does not create personal liability for company debts.*

4. **A founder is weighing the classic corporation against simpler business forms. Which statement captures the trade-off accurately?**
   - Corporations face less regulation, but their owners have unlimited liability
   - Corporations are cheap to set up, but their shares cannot be sold
   - Corporations protect their owners, but require almost no record-keeping
   - Corporations offer limited liability and easy ownership transfer, but bring more regulation, more paperwork, and double taxation

   *Answer: D. The corporate trade-off pairs limited liability and easy transfer of ownership with heavier regulation, more paperwork, and double taxation in the classic model. The other options describe the bargain backwards.*

5. **Bluepeak Analytics has twelve shareholders, and its shares are never offered for sale to the public; anyone who wants shares must buy them from an existing shareholder. How would you describe Bluepeak?**
   - A public corporation
   - A private corporation
   - A partnership
   - A government-owned enterprise

   *Answer: B. A private corporation's shares stay with a small group and are not traded on open markets, while a public corporation's shares are available to anyone. Bluepeak's shareholding pattern is the private case.*

## Sources

- OpenStax, Rice University. *Introduction to Business*, Section 4.3: Corporations: Limiting Your Liability. https://openstax.org/books/introduction-business/pages/4-3-corporations-limiting-your-liability (CC BY 4.0)
- U.S. Small Business Administration. *Choose a Business Structure* (Corporation / C corp). https://www.sba.gov/business-guide/launch-your-business/choose-business-structure
- U.S. Securities and Exchange Commission, Investor.gov. *Public Companies* (How Stock Markets Work). https://www.investor.gov/introduction-investing/investing-basics/how-stock-markets-work/public-companies

## Related Topics

- Introduction to Business: Forms of Business Ownership
- Introduction to Business: Sole Proprietorship
- Introduction to Business: Partnership
- Introduction to Business: LLC
- Introduction to Business: Finance Basics

## Editorial Metadata

- Topic ID: introduction-to-business:foundations:corporation
- Subject: introduction-to-business (Foundations)
- Editorial status: READY_TO_PUBLISH
- Researched at: 2026-08-21
- Research status: source-verified
- Rights: OpenStax section used under CC BY 4.0 with concepts adapted into original prose; SBA and SEC Investor.gov used as reference-only sources; no source prose reproduced
