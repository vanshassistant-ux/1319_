...
When a decision is genuinely hard, educators reach for classic frameworks. The consequences lens, also called utilitarianism, judges an action by its results: the ethical choice produces the greatest balance of good over harm for everyone affected. The duties lens, grounded in rights, judges an action by whether it respects the rights and dignity of the people affected — rights imply duties, such as the duty to tell the truth and not injure others. The virtues lens asks what kind of person the action builds: is it consistent with honesty, fairness, integrity, and courage? The Markkula Center presents these as lenses, not an answer machine: different lenses can point different ways, so careful decision-makers use more than one. The key is knowing the three classic lenses by name and by their core question.
...
- **Business ethics:** The application of ethical principles — moral standards of right and wrong — to business decisions and conduct.
- **Ethical issue:** A situation in which someone must choose between actions that may be ethical or unethical.
- **Stakeholder:** Any individual or group a business affects or has a responsibility to, including owners, employees, customers, and the community.
- **Conflict of interest:** A situation in which a personal interest could improperly influence a business decision.
- **Consequences lens:** An ethical approach that judges an action by its results, favoring the choice with the greatest balance of good over harm.
- **Duties lens:** An ethical approach that judges an action by whether it respects the rights and dignity of everyone affected.
- **Virtues lens:** An ethical approach that asks whether an action is consistent with character qualities such as honesty, fairness, and integrity.
- **Trust:** Confidence that a business will keep its promises and deal honestly, built slowly through repeated fair decisions.
- **Grey area:** A situation that is not clearly illegal but is still ethically questionable, where reasonable people may disagree.
...
- **Mistake:** Assuming that anything legal is automatically ethical. **Correction:** Law sets a minimum, not a ceiling. Some actions that are perfectly legal — like the personal loyalty bonus in the worked example — are still ethically questionable.
- **Mistake:** Thinking ethics only matters in big scandals or at famous companies. **Correction:** Most ethical questions are small and everyday — an honest label, a fair shift schedule, a returned deposit — and they accumulate into a reputation.
- **Mistake:** Believing a code of conduct or ethics policy makes a business ethical. **Correction:** A policy only works if people practice it in daily decisions. Ethics lives in behavior, not in a document.
- **Mistake:** Confusing stakeholders with shareholders. **Correction:** Owners and investors are one stakeholder group. Employees, customers, and the community are stakeholders too, each with legitimate interests a business must weigh.
- **Mistake:** Treating every dilemma as a choice between one clearly good and one clearly bad option. **Correction:** Many dilemmas are between two goods or two bads. That is exactly when the three lenses — consequences, duties, virtues — earn their keep.

## Compare / Contrast

- **Legal** vs **Ethical:** A legal action complies with the law; an ethical action holds up under moral standards. Many actions are both, but the categories differ: law can lag behind or miss areas that ethics covers.
- **The consequences lens** vs **The duties lens:** Consequences judges an action by its results — the greatest balance of good over harm — while duties judges whether the rights of everyone affected are respected, regardless of the outcome.
- **Stakeholders** vs **Shareholders:** Shareholders are the owners who hold shares in a company; stakeholders include anyone the business affects, from employees and customers to the surrounding community.
...
**1. Which option correctly lists the four stakeholder groups of a business?**

- [✓] A. Owners, employees, customers, and the community
- [ ] B. Managers, accountants, lawyers, and marketers
- [ ] C. Suppliers, banks, regulators, and competitors
- [ ] D. Shareholders, executives, auditors, and consultants

*Answer: A. OpenStax identifies stakeholders as the individuals or groups to whom a business has a responsibility: employees, customers, the general public, and investors. The other lists name business roles, professions, or outside parties, not the four stakeholder groups.*

**2. A factory owner argues that paying the minimum legal wage settles the company's responsibilities to its workers. Which idea from this lesson does that argument miss?**

- [✓] A. Legal compliance is not the same as acting ethically
- [ ] B. Stakeholders are limited to owners and investors
- [ ] C. Ethics applies only to advertising and marketing
- [ ] D. The consequences lens is the only valid framework

*Answer: A. The Markkula Center states that ethics is not the same as following the law: law incorporates many ethical standards but can deviate from what is ethical. A legal minimum wage is a floor, not a complete answer to how workers should be treated; the other options contradict the lesson.*

**3. A bakery manager asks an employee to re-date yesterday's cakes with today's stickers so the shop can keep selling them as 'fresh-baked all day.' Which common ethical issue does this raise?**

- [ ] A. A conflict of interest
- [✓] B. A misleading claim
- [ ] C. Unfair treatment of employees
- [ ] D. Environmental harm

*Answer: B. Re-dating makes customers believe the cakes are fresher than they are — a false impression about the product. OpenStax lists giving or allowing false impressions among recognizable unethical activities; the scenario involves no personal gain, no mistreatment of staff, and no environmental damage.*

**4. The owner of a delivery company is the cousin of its main supplier's sales director. The owner says the supplier always wins because it bids lowest, so there is nothing to examine. Which ethical concern should the company still address?**

- [ ] A. Misleading claims about delivery times
- [ ] B. Environmental harm from fuel use
- [✓] C. A conflict of interest that needs to be disclosed and managed
- [ ] D. Unfair treatment of customers

*Answer: C. A family tie between a decision-maker and a supplier is a conflict of interest — a situation where a personal relationship could improperly influence a business decision. Even a genuinely low bid does not remove the need for disclosure and oversight; the other options are not raised by the scenario.*

**5. A café owner refuses to raise prices even though costs are climbing, because the café is the only affordable meeting place for older residents in the neighborhood. If the owner is reasoning from consequences, which question is she most likely asking?**

- [ ] A. 'Does this decision respect everyone's rights?'
- [ ] B. 'What would a person of strong character do here?'
- [ ] C. 'Is this action permitted by law?'
- [✓] D. 'Which choice produces the greatest balance of good over harm for everyone affected?'

*Answer: D. The consequences (utilitarian) lens judges actions by their results — the greatest balance of good over harm for everyone affected — which matches weighing the residents' loss against the café's profit. Respecting rights is the duties lens, character is the virtues lens, and legality is not an ethical lens at all.*

## Sources

- OpenStax, Rice University — Introduction to Business, Section 2.1: Understanding Business Ethics — https://openstax.org/books/introduction-business/pages/2-1-understanding-business-ethics
- OpenStax, Rice University — Introduction to Business, Section 2.2: How Organizations Influence Ethical Conduct — https://openstax.org/books/introduction-business/pages/2-2-how-organizations-influence-ethical-conduct
- OpenStax, Rice University — Introduction to Business, Section 2.4: Responsibilities to Stakeholders — https://openstax.org/books/introduction-business/pages/2-4-responsibilities-to-stakeholders
- Markkula Center for Applied Ethics, Santa Clara University — A Framework for Ethical Decision Making — https://www.scu.edu/ethics/ethics-resources/ethical-decision-making/a-framework-for-ethical-decision-making/
- Corporate Finance Institute (CFI) — Business Ethics — https://corporatefinanceinstitute.com/resources/management/business-ethics/

## Related Topics

- introduction-to-business:foundations:what-is-a-business
- introduction-to-business:foundations:business-environment
- introduction-to-business:foundations:management
- introduction-to-business:foundations:marketing

## Editorial Metadata

- Topic ID: introduction-to-business:foundations:business-ethics
- Editorial status: READY_TO_PUBLISH
- Researched: 2026-08-21 (live web verification; OpenStax, Markkula Center, CFI)
