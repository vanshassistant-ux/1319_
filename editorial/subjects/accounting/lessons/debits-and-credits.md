...
- **Debit** — The left side of an account or journal entry; under the rules, assets and expenses increase on the debit side.
- **Credit** — The right side of an account or journal entry; under the rules, liabilities, equity, and revenue increase on the credit side.
- **Journal** — The chronological record where transactions first enter the accounting system, often called the book of original entry; journal entries have their own lesson.
- **T-account** — The simple two-column picture of an account, shaped like the letter T, with the debit side on the left and the credit side on the right.
- **Double-entry system** — The way of recording in which every transaction is entered with equal debits and credits, touching at least two accounts.
- **Entry** — The written record of one transaction, showing the accounts affected and the debit and credit amounts; journal entries have their own lesson.
- **Account** — The record of increases and decreases in one item a business tracks, such as Cash, Supplies, or Service Revenue.
...
**Where the analogy breaks down:** A seesaw has only two ends, but one entry can touch several accounts on each side at once — accountants call that a compound entry. And a level seesaw only proves the weights match; it cannot tell you that the weights were set on the right spots. A balanced entry is consistent, not automatically correct.
...
1. **Thinking debit means bad and credit means good.** Debit and credit only name the left and right sides of an account; a debit increases assets and expenses but decreases liabilities, equity, and revenue, so neither side carries a judgment.
2. **Assuming a credit always increases an account.** A credit increases liabilities, equity, and revenue, but it decreases assets and expenses — the effect depends on the account type, not the word.
3. **Recording a cash purchase of supplies as a credit to Supplies.** Supplies is an asset, and assets increase with debits, so buying supplies is a debit to Supplies; the cash you give up is the credit to Cash.
4. **Expecting every entry to have exactly one debit and one credit.** Simple entries have one of each, but compound entries touch several accounts on one or both sides; what must always hold is that total debits equal total credits.
5. **Treating a balanced entry as proof that the record is correct.** Balance only means the two sides match; an entry recorded in the wrong account, or a transaction missed entirely, still leaves the books balanced.

## Compare / Contrast

- **Debit vs. Credit** — Debit is the left side of an account and credit is the right side; every entry has both, and each side increases some account types while decreasing others.
- **Simple entry vs. Compound entry** — A simple entry has one debit and one credit; a compound entry has several accounts on one or both sides — both must end with equal debit and credit totals.
- **Everyday 'credit' vs. Accounting credit** — Everyday speech uses credit for praise or for borrowing; in the books, a credit is the right side, which increases liabilities, equity, and revenue and decreases assets and expenses.
...
**Q1.** In a journal entry, where do the debit and the credit sit?

- A. Debit on the left side, credit on the right side
- B. Debit on the right side, credit on the left side
- C. Debit on top, credit on the bottom
- D. Either side, whichever account is larger

**Key: A.** OpenStax's Principles of Accounting and CFI both place the debit on the left side of an account and the credit on the right side; the positions are fixed, not chosen by size.

**Q2.** Cedar & Pine Workshop buys $420 of printer supplies with cash from the register. Which entry records the transaction?

- A. Debit Cash $420, credit Supplies $420
- B. Debit Supplies $420, credit Accounts Payable $420
- C. Debit Supplies $420, credit Cash $420
- D. Debit Cash $420, credit Service Revenue $420

**Key: C.** Supplies is an asset and assets increase with debits, so Supplies is debited $420; Cash is an asset that decreases, and assets decrease with credits, so Cash is credited $420.

**Q3.** A café pays a $150 electricity bill with cash. Which side of which account increases?

- A. Cash increases with a debit
- B. Utility Expense increases with a debit
- C. Utility Expense increases with a credit
- D. Cash increases with a credit

**Key: B.** Expenses increase with debits, so the Utility Expense account grows on the debit side; Cash is an asset that decreases, which is a credit — OpenStax records a utility bill the same way, as a debit to Utility Expense and a credit to Cash.

**Q4.** Why must total debits equal total credits in every journal entry?

- A. Because banks require it before they process a payment
- B. Because every account must finish each period with a zero balance
- C. Because a mistake in the entry would otherwise be impossible to find
- D. Because equal debits and credits are what keep the accounting equation balanced

**Key: D.** CFI states that the debit and credit totals must always be equal for an entry to balance, and OpenStax shows that once entries are posted, the business checks that the accounting equation remains balanced — equal sides are the mechanism that keeps the equation in balance.

**Q5.** Which of the five account types increase with credits?

- A. Liabilities, equity, and revenue
- B. Assets, expenses, and revenue
- C. Assets and expenses
- D. Liabilities and expenses

**Key: A.** The rules pair the five account types with two sides: assets and expenses increase with debits, while liabilities, equity, and revenue increase with credits — OpenStax shows each of the credit-side types growing on the credit side, and CFI states the same rule in one line.

## Sources

- OpenStax, Rice University — *Principles of Accounting, Volume 1: Financial Accounting, Section 3.5: Use Journal Entries to Record Transactions and Post to T-Accounts*. https://openstax.org/books/principles-financial-accounting/pages/3-5-use-journal-entries-to-record-transactions-and-post-to-t-accounts
- Corporate Finance Institute (CFI) — *Debit Credit Analysis*. https://corporatefinanceinstitute.com/resources/accounting/debit-credit/
...
- Topic ID: accounting:foundations:debits-and-credits
- Editorial status: READY_TO_PUBLISH
- Researched at: 2026-08-21
- Provenance: EliExplains original synthesis; the working definition (debit = left side, credit = right side), the five account-type rules, and the T-account picture are synthesized with attribution from OpenStax's Principles of Accounting (Section 3.5) and corroborated by CFI's Debit Credit Analysis; the equation-balance rationale is corroborated by CFI's Accounting Equation and OpenStax Section 3.2; all examples original (Cedar & Pine Workshop is a fictional company).
- Framing: literacy level with simple illustrations; journal entries, the accounting equation, and the general ledger are sibling topics, referenced but not covered.
