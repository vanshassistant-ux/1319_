...
- **Asset** — A resource with economic value that a business owns or controls and expects to bring future benefit.
- **Current asset** — An asset expected to be used up, sold, or converted to cash within one year or less, such as cash or inventory.
- **Non-current asset** — A long-term asset not expected to be converted to cash or used up within a year, such as a building or a machine.
- **Accounts receivable** — Money customers owe the business for goods or services already delivered but not yet paid for.
- **Inventory** — The goods a business holds for sale to customers, such as a shop's stock of bikes.
- **Intangible asset** — An asset with no physical form, such as a patent, a trademark, or a brand name, whose value comes from the rights it gives.
- **Balance sheet** — The financial statement that reports a business's assets, liabilities, and equity at a single point in time.
- **Economic value** — The capacity of a resource to be exchanged for money or to produce future benefit.
...
- **Treating anything valuable as an asset.** The owner's personal car is not a business asset. An asset must be owned or controlled by the business and expected to bring it future benefit.
- **Thinking an asset has to be physical.** Patents, trademarks, and brand names have no physical form but are assets when they give the business rights that produce value.
- **Confusing assets with the money used to buy them.** When a business buys equipment with cash, cash falls but equipment rises; total assets may not change at all. The asset is what remains, not what was spent.
- **Judging an asset by its original price.** An asset is worth what it can produce going forward. A machine bought for $50,000 that nobody wants may be worth far less today.
- **Counting everything long-lasting as non-current.** Classification depends on how soon the asset is used up or converted to cash. Inventory can sit for months and still be a current asset because it is expected to sell within a year.

## Compare / Contrast

- **Current asset vs Non-current asset** — Current assets convert to cash or get used up within one year; non-current assets keep working for the business beyond a year.
- **Tangible asset vs Intangible asset** — Tangible assets have physical form, like a van or a building; intangible assets have none, like a patent or a brand name.
- **Asset vs Liability** — An asset is something the business owns or controls that can produce future benefit; a liability is an obligation the business owes to someone else.
...
1. **Which of these counts as an asset for a landscaping company?**
   - The lawn mower it owns and uses on jobs
   - The loan it owes the bank
   - The wages it has not yet paid its crew
   - The fuel it burned last week
   - *Answer: The lawn mower it owns and uses on jobs. The mower is owned by the company and will produce future benefit, so it is an asset; the loan and unpaid wages are liabilities, and the burned fuel is a cost already used up.*

2. **A bakery buys flour and sugar that it expects to use up within the year. How should these be classified?**
   - Non-current assets, because they are physical
   - Intangible assets, because they will be consumed
   - Current assets, because they will be used up within a year
   - Liabilities, because the bakery owes for them
   - *Answer: Current assets, because they will be used up within a year. Current assets are expected to be used up or converted to cash within one year; flour and sugar fit that definition, while the other choices describe the wrong classes.*

3. **A furniture shop sells a $2,000 couch to a customer who will pay next month. What happens to the shop's assets today?**
   - Cash increases by $2,000
   - Inventory increases by $2,000
   - Nothing changes until the customer pays
   - Accounts receivable increases by $2,000
   - *Answer: Accounts receivable increases by $2,000. Because payment comes later, the shop gains a right to collect the $2,000 — an account receivable, which is an asset; cash has not arrived, inventory has fallen, and the sale is already recorded.*

4. **Which of these is an intangible asset?**
   - A delivery van
   - A patent on a new bottle design
   - A warehouse full of boxes
   - The cash in the register
   - *Answer: A patent on a new bottle design. A patent has no physical form but gives the business a right that produces future benefit, which makes it an intangible asset; the van, warehouse, and cash are all tangible.*

5. **A delivery company owns a warehouse in a town where demand for its service has collapsed. What does the honest framing say about that warehouse as an asset?**
   - It is worth its purchase price until it is sold
   - It is no longer an asset of any kind
   - Its value depends on what it can still produce for the business
   - It automatically becomes a liability
   - *Answer: Its value depends on what it can still produce for the business. An asset is worth what it can produce going forward, so a warehouse with little future use has limited value despite its original cost; it stays an asset, but a weak one, and it never becomes a liability.*

## Sources

- OpenStax, Rice University — Principles of Accounting, Volume 1: Financial Accounting, Section 3.2 (Define and Describe the Expanded Accounting Equation and Its Relationship to Analyzing Transactions). CC BY 4.0. https://openstax.org/books/principles-financial-accounting/pages/3-2-define-and-describe-the-expanded-accounting-equation-and-its-relationship-to-analyzing-transactions
- OpenStax, Rice University — Principles of Accounting, Volume 1: Financial Accounting, Section 2.1 (Describe the Income Statement, Statement of Owner's Equity, Balance Sheet, and Statement of Cash Flows, and How They Interrelate). CC BY 4.0. https://openstax.org/books/principles-financial-accounting/pages/2-1-describe-the-income-statement-statement-of-owners-equity-balance-sheet-and-statement-of-cash-flows-and-how-they-interrelate
- Corporate Finance Institute — Types of Assets: List of Asset Classification on the Balance Sheet. Reference only. https://corporatefinanceinstitute.com/resources/accounting/types-of-assets/
- U.S. Securities and Exchange Commission (Investor.gov) — Asset (glossary entry). U.S. government work. https://www.investor.gov/introduction-investing/investing-basics/glossary/asset
- Corporate Finance Institute — Accounting Equation. Reference only. https://corporatefinanceinstitute.com/resources/accounting/accounting-equation/
...
- accounting:foundations:inventory

## Editorial Metadata

- Topic ID: accounting:foundations:assets
- Subject: accounting, Unit: foundations
- Editorial status: READY_TO_PUBLISH
- Research status: source-verified (researched 2026-08-21)
- Rights: OpenStax concepts adapted into original prose under CC BY 4.0; CFI and Investor.gov used as reference-only sources; no source prose reproduced
