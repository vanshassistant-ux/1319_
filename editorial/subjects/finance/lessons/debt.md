...
Debt in finance is money that has been borrowed and must be repaid, usually with interest. The amount borrowed is the principal, and interest is the price paid for borrowing it. The common forms are loans, bonds, and credit. Debt is borrowing, not ownership: lenders must be repaid on a schedule, while owners share in the business's results. Businesses use debt to grow, which finance calls leverage, but the payments arrive whether or not sales hold up. Debt is a tool with a schedule.
...
Debt is a tool with a schedule. The tool part: borrowed money funds growth, equipment, and purchases that would otherwise wait. The schedule part: every form of debt carries repayment terms, the amount, the interest, and the date, and those terms do not bend. Original example: a bakery's oven loan is a fine tool in a good year, when sales cover the monthly payment easily. The same loan becomes a weight in a bad one, when a flooded kitchen closes the shop for a month and the payment still arrives. Debt is not good or bad on its own. What matters is whether the borrower understands the schedule and can keep it.

## Key Vocabulary

- **Debt** — Money that has been borrowed and must be repaid, typically with interest, according to agreed terms.
- **Principal** — The total amount of money that was borrowed or lent, before any interest is added.
- **Interest** — The price paid for borrowing money, expressed as a percentage of the amount borrowed.
- **Loan** — A form of debt in which a lender gives a borrower a set amount of money to be repaid by a certain date, usually with interest.
- **Bond** — A debt security in which the borrower promises to pay interest during its life and repay the principal when it matures.
- **Credit** — A form of debt that lets a borrower use money up to a set limit and repay it repeatedly, such as a credit card or line of credit.
- **Repayment schedule** — The agreed timing and amounts of the payments a borrower must make to pay a debt back.
- **Seniority** — The order in which lenders' claims are paid if a borrower fails, with senior debt paid before junior claims.
- **Leverage** — The use of borrowed money to finance a business, aiming to earn more than the interest costs.
...
Where the analogy breaks down: A lawnmower is returned once and the favor is over, while debt keeps generating payments for years. A friend might forgive a late return; a lender will not forgive a missed payment. And unlike the borrowed mower, debt costs money the whole time you hold it.
...
- **Treating debt as free money.** — The borrowed amount is not income the business keeps; debt must be repaid, typically with interest, according to the agreed terms.
- **Confusing debt with equity.** — Debt must be repaid on a schedule; equity is ownership that requires no repayment but gives up a share of the business and its profits.
- **Forgetting that debt runs on a schedule.** — Every debt has repayment terms with a date; a promising idea or a busy season does not pause the payments.
- **Thinking leverage only boosts gains.** — Borrowed money amplifies results in both directions: when sales drop, the fixed payments still arrive, and heavy debt can threaten the business itself.

## Compare / Contrast

- **Debt vs Equity** — Debt is borrowed money that must be repaid with interest on a schedule; equity is ownership that shares in the business's results. Lenders' claims come first, owners' claims come last.
- **Loan vs Bond** — A loan is an agreement between one borrower and one lender with repayment terms; a bond is a debt security sold to many investors, who can trade it, with interest paid during its life and principal repaid at maturity.
...
1. **In finance, what is debt?**
   - A. Money a business receives that it never has to repay
   - B. Money that has been borrowed and must be repaid, usually with interest
   - C. A share of ownership in a company
   - D. The profit a company keeps after paying its expenses
   - **Answer: B.** Debt is money that has been borrowed and must be repaid, typically with interest. Money that never has to be repaid is a gift, ownership is equity, and leftover profit is retained earnings, not debt.

2. **A bakery borrows $40,000 from a credit union to buy a new oven, agreeing to repay the full amount with interest over five years. What form of debt is this?**
   - A. A bond
   - B. Revolving credit
   - C. Equity
   - D. A loan
   - **Answer: D.** The bakery received a set amount of money from one lender, the credit union, and must repay it with interest by a set date. That is a loan. Bonds are sold to many investors, credit is reusable up to a limit, and equity is ownership, not borrowing.

3. **A coffee chain borrows $2 million to open ten new stores, expecting the stores to earn more than the interest on the borrowed money. What is this use of borrowed money called?**
   - A. Leverage
   - B. Amortization
   - C. Seniority
   - D. Principal
   - **Answer: A.** Using borrowed money to expand a business, expecting the growth to earn more than the interest costs, is leverage. Amortization is a repayment method, seniority is the order of claims, and principal is the amount borrowed.

4. **A delivery company issues bonds to fund a new fleet of trucks. What does the company owe its bondholders?**
   - A. A share of the company's future profits
   - B. Interest payments that may be skipped in a weak year
   - C. Regular interest payments during the life of the bonds and the principal back at maturity
   - D. The principal back immediately, before any interest is paid
   - **Answer: C.** A bond issuer promises to pay interest during the life of the bond and to repay the principal when it matures. Bondholders are lenders, not owners, so they get no share of profits, and the payments are obligations, not options.

5. **A company fails and its assets are divided among claimants. Which group's claim is paid first under seniority?**
   - A. Common shareholders
   - B. Senior creditors, such as senior bondholders
...
- Liability/Debt (Investor.gov glossary) — https://www.investor.gov/introduction-investing/investing-basics/glossary/liabilitydebt
- Interest (Investor.gov glossary) — https://www.investor.gov/introduction-investing/investing-basics/glossary/interest
- Bonds (Investor.gov glossary) — https://www.investor.gov/introduction-investing/investing-basics/glossary/bonds
- Principal (Investor.gov glossary) — https://www.investor.gov/introduction-investing/investing-basics/glossary/principal
- Senior Bond (Investor.gov glossary) — https://www.investor.gov/introduction-investing/investing-basics/glossary/senior-bond
- OpenStax Principles of Finance, Section 17.1: The Concept of Capital Structure — https://openstax.org/books/principles-finance/pages/17-1-the-concept-of-capital-structure
...
- Investopedia — Debt: What It Is, How It Works, Types, and Ways to Pay Back — https://www.investopedia.com/terms/d/debt.asp
