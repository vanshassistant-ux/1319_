...
- **Return** — The gain or loss on an investment over a period of time, usually expressed as a percentage of the starting value.
- **Simple return** — The percentage change in an investment's value, calculated as (ending value − starting value) ÷ starting value.
- **Income** — Payments an investment makes while it is held, such as dividends on a stock or interest on a bond.
- **Capital gain** — The profit from an investment whose price rises above what was paid for it.
- **Capital loss** — The loss from an investment whose price falls below what was paid for it.
- **Expected return** — The return an investor anticipates before the outcome is known; a forecast, not a promise.
- **Realized return** — The return that actually occurred over a specific period, measured after the fact.
- **Annualized return** — A return restated as a yearly figure so investments held for different lengths of time can be compared.
- **Total return** — The return that combines income received with the change in price.
...
- **Treating return as always a gain** — A return can be negative. An investment that lost value produced a negative return, which is still a return.
- **Forgetting that income counts** — A price that never moves can still produce a return through dividends or interest; total return combines income with price change.
- **Confusing expected with realized** — The expected return is the forecast made in advance; the realized return is the record of what actually happened. They often differ.
- **Comparing returns on different time frames** — A 10% return over one month and a 10% return over three years are not the same achievement; returns must be put on a common yearly basis to compare fairly.
- **Reading the past as a promise** — Past returns are history; expected returns are based on historical data and are not guaranteed, and every investment carries some risk.

## Compare / Contrast

- **Income vs capital gain** — Income is what the investment pays you while you hold it, like interest or dividends; a capital gain is the rise in the investment's own price. Both count toward total return, and a fall in price is a capital loss.
- **Expected return vs realized return** — Expected return is what you anticipate before the outcome, a forecast built from possible outcomes; realized return is what actually occurred over the period, measured after the fact.
...
1. **In finance, what is a return on an investment?**
   - A. The gain or loss on an investment over a period of time
   - B. The fee an investment firm charges for managing money
   - C. The amount of money originally invested
   - D. The number of years an investment is held
   - **Answer: A.** A return is the gain or loss on an investment over a period of time, usually expressed as a percentage of the starting value. Fees, the original amount, and the holding period are not what the term means.

2. **Priya bought a share for $200 and sold it one year later for $230. Using the simple return formula, what was her return?**
   - A. 30%
   - B. 15%
   - C. 13%
   - D. 10%
   - **Answer: B.** Return = (ending value − starting value) ÷ starting value = ($230 − $200) ÷ $200 = $30 ÷ $200 = 0.15, or 15%. The other choices do not follow from the arithmetic.

3. **Leila's investment paid $60 in interest during the year, and its price rose from $1,000 to $1,040. Which part of her return is the capital gain?**
   - A. The $60 in interest payments
   - B. The $1,000 she originally paid
   - C. The $100 total of income plus price change
   - D. The $40 rise in price
   - **Answer: D.** A capital gain is the rise in an investment's price — here the $40 increase from $1,000 to $1,040. The $60 in interest is income, not a capital gain.

4. **Before the year began, a fund manager expected a fund to return 8%. At year-end, the fund had returned 3%. What do the two numbers represent?**
   - A. 8% is the realized return and 3% is the expected return
   - B. Both are expected returns because they were known in advance
   - C. 8% is the expected return and 3% is the realized return
   - D. Both are realized returns because real money was involved
   - **Answer: C.** The expected return is what was anticipated before the outcome, 8%; the realized return is what actually happened, 3%. Expectations are forecasts, realized returns are records.

5. **A television ad says a fund earned 18% last year and invites viewers to invest today. Based on the honest framing of returns, what should a viewer conclude?**
   - A. The fund is guaranteed to earn at least 18% this year
   - B. Last year's 18% is history; future returns are not promised
...
- Corporate Finance Institute (CFI) — Rate of Return — https://corporatefinanceinstitute.com/resources/valuation/rate-of-return-guide/
- Corporate Finance Institute (CFI) — Expected Return — https://corporatefinanceinstitute.com/resources/valuation/expected-return/
- Investopedia — Return: What It Means in Investing — https://www.investopedia.com/terms/r/return.asp
