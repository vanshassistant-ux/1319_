...
The phrases member-managed and manager-managed are useful classroom labels for two broad patterns of authority. In a member-managed pattern, members retain management authority. In a manager-managed pattern, management authority is placed in one or more managers under the applicable law and governing agreement. The labels describe allocation of authority; they do not by themselves tell a reader who owns what percentage, who has every voting right, or who bears responsibility for a particular event.
...
- **limited liability company (LLC):** A business structure permitted by state law whose owners are generally called members.
- **member:** An owner of an interest in an LLC.
- **manager:** A person given authority to manage an LLC under applicable law and its governing agreement.
- **member-managed:** An LLC authority pattern in which members manage the business, subject to applicable law and its governing agreement.
- **manager-managed:** An LLC authority pattern in which one or more managers are assigned management authority, subject to applicable law and its governing agreement.
- **LLC agreement:** An internal agreement that can allocate rights, authority, and procedures for an LLC; it is often called an operating agreement.
- **limited liability:** A qualified legal feature that can separate LLC obligations from members' or managers' personal obligations based solely on their status, subject to applicable law and facts.
- **federal tax classification:** The treatment assigned to an entity under federal tax rules, which can be distinct from its state-law business structure.
...
The analogy has limits: an LLC is a legal organization, not a club. Legal authority, liability, and tax classification can have consequences that a club chart cannot capture, and state law plus the actual agreement may change the answer.
...
- **Assuming that every member automatically manages the LLC.** Identify the applicable state-law default and the LLC agreement; management can be vested in members or designated managers.
- **Treating a manager as necessarily an owner.** Keep management authority and membership ownership separate unless the relevant law and agreement show that they coincide.
- **Saying limited liability means that the LLC has no debts or that no person can ever be obligated.** Describe it as a qualified legal feature and recognize that law, agreements, and facts can matter.
- **Using an LLC label as a complete federal tax answer.** Treat state-law structure and federal tax classification as separate questions; tax treatment can depend on members and elections.

## Compare / Contrast

| A | B | Distinction |
| --- | --- | --- |
| Member | Manager | A member holds an ownership interest; a manager holds management authority. One person can sometimes be both, but the roles are conceptually distinct. |
| Member-managed | Manager-managed | The first pattern places management with members; the second places it with one or more managers, subject to applicable law and the governing agreement. |
| State-law LLC structure | Federal tax classification | The first concerns the legal form created under state law; the second concerns treatment under federal tax rules and may depend on members and elections. |
...
1. **In the standard LLC vocabulary used in this lesson, what is a member?**
   - A. A person who owns an interest in the LLC.
   - B. A court that hears LLC disputes.
   - C. A federal tax classification.
   - D. A filing fee paid to a state.
   - **Answer: A.** A member is an LLC owner.

2. **Which statement best distinguishes a member-managed pattern from a manager-managed pattern?**
   - A. The first has no owners, while the second has owners.
   - B. The first places management with members, while the second assigns management to one or more managers under applicable law and the agreement.
   - C. The first is federal law, while the second is state law.
   - D. The first has limited liability, while the second does not.
   - **Answer: B.** The distinction concerns allocation of management authority.

3. **A fictional LLC's agreement designates Priya, who is also a member, to manage ordinary business affairs. What is the most accurate conclusion?**
   - A. Priya cannot be an owner because she is a manager.
   - B. Every member has necessarily lost every right to vote.
   - C. Priya may hold both a membership role and a management role; the agreement and applicable law determine the scope of authority.
   - D. The LLC must be federally taxed as a corporation.
   - **Answer: C.** A person can be both a member and manager in the Delaware statutory example.

4. **What does the Delaware statutory example teach about limited liability?**
   - A. An LLC can never owe a debt.
   - B. A member is personally immune from every claim in every jurisdiction.
   - C. A manager can never agree to a personal obligation.
   - D. LLC obligations are generally the LLC's, and a member or manager is not personally obligated solely due to that status, while agreements can matter.
   - **Answer: D.** Delaware's statute supplies that qualified rule and permits agreements to matter.

5. **A classmate says, “It is an LLC, so we already know its federal tax treatment.” Which response is best?**
   - A. Yes; every LLC has one fixed federal treatment.
   - B. No; an LLC is a state-law structure, and federal classification can depend on the number of members and elections.
   - C. Yes; state law and federal tax rules are the same question.
   - D. No; LLCs are not recognized under any tax rules.
   - **Answer: B.** The IRS explains that classification can depend on membership and elections.

## Sources

- Internal Revenue Service, [Limited liability company (LLC)](https://www.irs.gov/businesses/small-businesses-self-employed/limited-liability-company-llc) (read 2026-08-20; reference only).
- Delaware General Assembly, [Delaware Code Online, Title 6, Chapter 18, Subchapter IV: Managers](https://delcode.delaware.gov/title6/c018/sc04/index.html) (read 2026-08-20; reference only; Delaware illustration, not nationwide law).
- Delaware General Assembly, [Delaware Code Online, Title 6, Chapter 18, Subchapter III: Members](https://delcode.delaware.gov/title6/c018/sc03/index.html) (read 2026-08-20; reference only; Delaware illustration, not nationwide law).
...
- **Rights:** Reference-only government sources; no source prose or statutory text adapted.
- **Scope note:** Original general education, not entity-selection, formation, legal, or tax advice.
