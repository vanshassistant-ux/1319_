...
A milestone is a significant point or event that makes progress, a review, a decision, or a handoff visible in a project’s current schedule. It is not the same as a task, which is work someone performs, or a deliverable, which is a result produced by work. “Accessibility review complete” can be a milestone; drafting the review materials is a task, and the reviewed materials are a deliverable. A milestone communicates a meaningful state, but it does not prove that every surrounding detail is settled.

## Why This Matters

Teams often say a project is “on track” without agreeing on what evidence would support that statement. Well-chosen milestones make important points visible enough to discuss: Was the prototype actually reviewed? Is a decision needed before later work proceeds? Has a result been handed over? This is valuable for shared understanding in predictive, adaptive, and hybrid work. A milestone is not a promise of success, a substitute for a task list, or a universal approval rule. Learning to separate the event from the work and evidence around it helps students read a schedule more critically and communicate uncertainty honestly.
...
A decision point is a milestone-like event at which a relevant choice needs to be considered or recorded. For example, after a prototype review, people with appropriate responsibility might decide whether the current direction is suitable to continue exploring. The decision point does not tell a real organization who must approve a change or what choice must be made. It makes the need for a decision visible. Confusing it with an automatic authorization can lead a learner to infer authority that a schedule entry does not create.
...
- **milestone:** A significant point or event that makes an important project state, review, decision, or handoff visible.
- **task:** A planned unit of work performed to contribute to a project result or event.
- **deliverable:** A result produced by project work that can be used, reviewed, accepted, or handed over.
- **decision point:** A stated event at which relevant people need to consider or record a choice.
- **evidence:** Information that can be examined to support a bounded claim about whether an event or condition occurred.
- **handoff:** The transfer or making available of a result, responsibility, or information for another person or group to use.
- **status communication:** A concise account of the current project state, including relevant progress, uncertainty, and open matters.
...
The analogy has limits. Project events can need different kinds of evidence, may happen in parallel, and can involve decisions by people with different responsibilities. A checkpoint stamp also cannot predict the rest of the route or decide what a real project team should do next.
...
- **Calling every task a milestone.** Use milestones for significant events or states; retain tasks for the work that leads to them.
- **Treating a deliverable as the same thing as the event of reviewing or handing it over.** Name the result and the significant event separately when both matter.
- **Reporting a planned milestone as completed.** Distinguish what is scheduled from evidence that the event occurred.
- **Assuming a decision-point label grants authority or settles an issue.** It signals a choice for the appropriate people to consider; it does not dictate their process or outcome.

## Compare / Contrast

| A | B | Distinction |
| --- | --- | --- |
| Task | Milestone | A task describes work to perform; a milestone marks a significant point or event. |
| Deliverable | Milestone | A deliverable is a result; a milestone can mark the result becoming ready, reviewed, or handed over. |
| Planned milestone | Achieved milestone | A planned milestone is an expectation in the current plan; an achieved milestone is supported by evidence that the named event occurred. |
| Decision point | Decision | A decision point makes a needed choice visible; a decision is the choice actually made by the appropriate people. |
...
1. **Which schedule entry marks a significant point rather than work to be performed?**
   ...
   - D. Estimate that review may take two days.

2. **A team has a completed prototype but has not yet shown it to reviewers. Which statement best distinguishes the deliverable from the milestone?**
   - A. The prototype is a milestone because all deliverables are events.
   - B. Both are tasks because neither needs evidence.
   - C. The review milestone is complete because the prototype exists.
   - D. The prototype is a deliverable; “prototype reviewed” would be a milestone after the review event occurs. **Correct.**

3. **Which evidence most directly supports the claim that a planned community review milestone was achieved?**
   - A. A calendar entry created before the review.
   - B. An estimate of the review’s duration.
   - C. The reviewed material plus a dated record or summary showing the review occurred. **Correct.**
   - D. A list of future tasks unrelated to the review.

4. **What is the most accurate meaning of a decision point on a project schedule?**
   - A. It automatically authorizes a specific action.
   - B. It guarantees that every disagreement is resolved.
   - C. It replaces the evidence needed for a review.
   - D. It makes a needed choice visible for the people with appropriate responsibility to consider. **Correct.**

5. **A status update says “review completed; keyboard-navigation question remains open.” Why is this stronger than “everything is on track”?**
   - A. It guarantees the project will finish as originally planned.
   - B. It treats an open issue as irrelevant after a meeting.
   - C. It distinguishes the observed milestone from the unresolved condition that still needs attention. **Correct.**
   - D. It converts a milestone into a duration estimate.

## Sources

- U.S. Government Accountability Office, [Schedule Assessment Guide: Best Practices for Project Schedules (GAO-16-89G)](https://www.gao.gov/products/gao-16-89g) — public-domain source for a schedule’s relationship to planned work, major events, and comparison with an approved plan.
- Project Management Institute, [Standards & Publications](https://www.pmi.org/standards) — reference-only source confirming scheduling as a distinct practice area; this lesson uses original prose only.
- Project Management Institute, [PMI Lexicon of Project Management Terms, Version 5.0](https://www.pmi.org/-/media/pmi/documents/registered/pdf/pmbok-standards/pmi-lexicon-pm-terms.pdf?rev=447328d841c249af985d14177ddd5f95) — reference-only terminology source for the bounded use of milestone and schedule-baseline terms.
...
- **Topic ID:** `project-management:foundations:milestones`
...
- **Scope note:** General education on milestones, evidence, and status communication; excludes scheduling calculations, critical-path methods, estimation depth, and organization-specific approval processes.
