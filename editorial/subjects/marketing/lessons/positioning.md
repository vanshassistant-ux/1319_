...
Positioning is designing an offering so it owns a distinct place in the customer's mind — the spot it occupies next to competitors. It is the third step of the STP sequence: segment, target, position. Marketers write a positioning statement — for whom, what, versus whom, and why — to keep that place clear. Differentiation is the distinct value the brand stands for. A position only works if it is true: a promise customers can check, and a promise you must keep.
...
1. **Treating a slogan as the position.**
   - A tagline is the visible tip; the position is the place in the mind. If the team cannot say who the offering is for and why it beats the alternatives, there is no position yet.
2. **Positioning for everyone.**
   - A statement that says 'for anyone who likes good food' gives the mind nothing to file; the place belongs to whoever is more specific.
3. **Claiming a difference everyone claims.**
   - 'Quality ingredients' or 'friendly service' are table stakes; a position needs a difference customers can name that competitors cannot honestly copy.
4. **Forgetting the versus.**
   - A statement that names the customer and the benefit but never the alternatives leaves the comparison — the whole point — unwritten.
5. **Promising what you cannot deliver.**
   - A position that outruns the actual product is a lie customers discover, and the collapse is worse than never claiming the place.

## Compare / Contrast

- **Positioning vs market segmentation**: Segmentation divides the market into groups with shared needs (a sibling topic); positioning chooses the place the offering will own in the minds of the group the company decided to serve.
- **Head-to-head vs differentiation**: Head-to-head competes directly with rivals on the same attributes; differentiation emphasizes unique qualities and seeks customers who value them.
- **Positioning statement vs mission statement**: A mission statement tells the world what the company exists to do; a positioning statement is the internal compass for how the offering should be seen against competitors.
...
**A marketing team has already divided its market into groups of customers with shared needs and picked the one group it will serve. What step remains in the STP model?**

- Positioning the offering for that group (correct)
- Re-segmenting the market by income
- Pricing the product below all competitors
- Writing a mission statement

*The STP model runs segment, target, position. Segmentation and targeting are done; positioning the offering for the chosen group is the remaining third step.*
...
- The 'is the [market]' part
- The 'For [target audience]' part (correct)
- The 'because [evidence]' part
- The 'delivers [points of differentiation]' part

*The 'For [target audience]' opening names whom the position is for; the other parts answer what the brand is, what it delivers, and why to believe it.*
...
- Customers will praise the shop for aiming high
- Rivals will copy the 48-hour claim
- The position collapses as customers learn the promise is false (correct)
- The shop can keep the position as long as the slogan stays catchy

*A position is a promise customers can check. When the 48-hour promise fails repeatedly, customers update their view of the shop, and the position collapses into the opposite of the intended place in their minds.*

**Two bakeries sit across the street from each other. Sunrise Bakery advertises 'fresher bread than any bakery in town' and compares itself directly to its rival. Bluebird Bakery instead sells only bread from a sourdough starter it has kept alive for decades. Which pairing describes the two approaches?**

- Both use head-to-head positioning
- Sunrise uses differentiation; Bluebird uses head-to-head positioning
- Both use differentiation positioning
- Sunrise uses head-to-head positioning; Bluebird uses differentiation (correct)

*Sunrise compares itself directly with its rival on the same attribute — head-to-head positioning. Bluebird emphasizes a unique quality no competitor can copy — differentiation positioning.*

**A bookstore that long held the position 'the town's discount book warehouse' finds that shoppers now care more about community events and reading space. The owners remodel and market the store as 'the neighborhood's reading room with a book club every week.' What is this change called?**
...
- Corporate Finance Institute (CFI) — Market Segmentation — https://corporatefinanceinstitute.com/resources/management/market-segmentation/
