...
The body does not leave electrolyte levels to chance. Healthy kidneys filter the blood constantly and keep the right balance of electrolytes, as the Merck Manual puts it. The kidneys hold onto what the body needs and let the excess pass out in urine. When something upsets the system, levels drift: an electrolyte imbalance means the level of one or more electrolytes is too low or too high. The common causes are familiar — severe vomiting or diarrhea, heavy sweating, not drinking enough fluids, certain medicines, and kidney problems themselves. Balance, in other words, is an active process, not a default state.
...
- **Electrolyte** — A mineral that carries an electric charge when dissolved in water or body fluids such as blood.
- **Mineral** — A naturally occurring element, such as sodium or calcium, that the body needs for normal function.
- **Electric charge** — A property of particles that makes them attract or repel one another; in electrolytes, it is what allows them to carry signals.
- **Sodium** — An electrolyte that helps control the amount of fluid in the body and supports nerve and muscle function; table salt is its main food source.
- **Potassium** — An electrolyte needed for muscle contraction and nerve transmission, found in fruits such as bananas and in vegetables.
- **Calcium** — The most abundant mineral in the body, stored mainly in bones and teeth, and needed for muscles to move and nerves to send messages.
- **Electrolyte imbalance** — A condition in which the level of one or more electrolytes in the body is too low or too high.
- **Kidney** — One of two organs that filter the blood and keep the right balance of water and electrolytes in the body.
...
1. **Treating electrolytes as something only athletes need.** Every body uses electrolytes every second for nerve signals, muscle contraction, and fluid balance. Sports drinks are a choice for long or intense exercise, not a daily requirement.
2. **Assuming more electrolytes are always better.** An imbalance means a level is too low or too high. Healthy kidneys keep levels steady, and pushing extra electrolytes can push a level in the wrong direction.
3. **Believing a sports drink is the best or only way to replace electrolytes after ordinary activity.** Food and water replace what routine sweat removes. Sports drinks add sugar and electrolytes and are mainly helpful after intense, prolonged exercise.
4. **Using "salt" and "sodium" as if they were the same thing.** Table salt is a compound; sodium is one of its parts and chloride is the other. Sodium is one electrolyte among five, not the whole story.

## Compare / Contrast

- **Sodium vs. Potassium** — Both carry charge and support nerves and muscles, but sodium comes mainly from salt while potassium comes mainly from fruits, vegetables, and dairy — which is why a salty, low-produce diet skews the balance.
- **Electrolytes vs. Vitamins** — Both are nutrients the body needs, but electrolytes are minerals that carry an electric charge when dissolved in water, while vitamins are carbon-based compounds with different jobs and no charge.
- **Sports drinks vs. Water with meals** — Both replace fluid, but sports drinks add electrolytes and sugar and are mainly for intense, prolonged exercise, while water plus ordinary food replaces routine losses without the extra sugar.
...
1. At the store, Lina picks up a drink labeled "with electrolytes." She asks for a one-sentence description of what an electrolyte is. Which sentence is accurate?
   - A mineral that carries an electric charge when dissolved in water.
   - A vitamin that helps the body store extra energy as fat.
   - A protein that builds and repairs muscle tissue.
   - A sugar that gives the body quick fuel during exercise.
   **Answer: A mineral that carries an electric charge when dissolved in water.** The working definition, used by MedlinePlus, is that electrolytes are minerals that carry an electric charge when dissolved in water or body fluids. Vitamins, proteins, and sugars are different nutrient classes.

2. During a long hike, Kai's calf muscles cramp and his steps feel clumsy. His hiking partner says his electrolytes are probably low. Which pair of jobs most directly explains his symptoms?
   - Storing fat and building bone.
   - Digesting protein and absorbing sugar.
   - Carrying nerve signals and helping muscles contract.
   - Clotting blood and fighting infection.
   **Answer: Carrying nerve signals and helping muscles contract.** Electrolytes support nerve function and muscle contraction, so when levels drop, cramping and unsteady movement are common symptoms.

3. After two days of stomach flu with vomiting, Aisha feels weak and her doctor says her electrolyte levels are off. What is the most likely reason for the imbalance?
   - Her kidneys stopped producing electrolytes during the illness.
   - Her muscles used up all her electrolytes fighting the virus.
   - She drank too much water and washed the electrolytes out.
   - Vomiting removed water and electrolytes faster than she could replace them.
   **Answer: Vomiting removed water and electrolytes faster than she could replace them.** MedlinePlus lists severe vomiting and diarrhea among the most common causes of an electrolyte imbalance.

4. Diego says, "I sweat during my normal one-hour gym session, so I always follow it with a sports drink — it is the only way to replace what I lost." Which response is the most accurate?
   - He is right: after any sweating, only a sports drink can restore electrolyte balance.
   - For an ordinary workout, food and water replace what sweat removes; sports drinks are mainly for long or intense exercise.
   - He is right that he lost electrolytes, but he should double the sports drink to be safe.
   - He should not replace electrolytes at all, since the body makes its own.
   **Answer: For an ordinary workout, food and water replace what sweat removes; sports drinks are mainly for long or intense exercise.** Electrolyte drinks may be helpful after intense exercise in adults but are not typically needed for everyday activity.

5. Nia packs a lunch of a banana, a cup of yogurt, and a sandwich with a little salt on the bread. Which set of electrolytes does her lunch supply?
   - Potassium, calcium, and sodium.
   - Iron, zinc, and iodine.
   - Vitamin C, vitamin D, and vitamin B12.
   - Fiber, starch, and protein.
   **Answer: Potassium, calcium, and sodium.** The banana supplies potassium, the yogurt supplies calcium and potassium, and the salt supplies sodium.

## Sources

- MedlinePlus, National Library of Medicine — Fluid and Electrolyte Balance: https://medlineplus.gov/fluidandelectrolytebalance.html
- Merck Manual Consumer Version — Overview of Electrolytes: https://www.merckmanuals.com/home/quick-facts-hormonal-and-metabolic-disorders/electrolyte-balance/overview-of-electrolytes
...
- MedlinePlus, National Library of Medicine — Potassium in diet: https://medlineplus.gov/ency/article/002413.htm
- MedlinePlus, National Library of Medicine — Low-salt diet: https://medlineplus.gov/ency/patientinstructions/000109.htm
- MedlinePlus, National Library of Medicine — Chloride in diet: https://medlineplus.gov/ency/article/002417.htm
- OpenStax (Rice University) — Nutrition for Nurses, Section 2.4: Hydration: https://openstax.org/books/nutrition/pages/2-4-hydration
...
- Topic ID: nutrition:foundations:electrolytes
- Subject / Unit: nutrition / foundations
- Phase: 4
- Editorial status: READY_TO_PUBLISH
- Researched: 2026-08-22
- Provenance: EliExplains original synthesis; facts verified against MedlinePlus, NIH ODS, Merck Manual, and OpenStax; reference-only sources; no source prose adapted.
