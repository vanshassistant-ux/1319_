...
Metabolic reactions come in two broad kinds, and they run at the same time. Anabolism is the building and storing side. It uses small building blocks, such as amino acids from digested protein, and assembles them into larger, more complex molecules the body needs, such as new muscle protein. It also stores energy for later, for example by packing glucose into a stored form in the liver and muscles. Catabolism is the breaking-down side. It takes large molecules, mostly carbohydrates and fats, and splits them apart to release energy. That released energy fuels anabolism, warms the body, and lets muscles contract. The breakdown also produces waste products, which leave the body through the skin, kidneys, lungs, and intestines.
...
- **Metabolism:** All the physical and chemical processes in the body that convert or use energy, from breathing and circulating blood to digesting food and powering the brain.
- **Anabolism:** The building and storing side of metabolism, in which the body assembles small molecules into larger ones, such as turning amino acids into muscle protein.
- **Catabolism:** The breaking-down side of metabolism, in which the body splits large molecules apart to release energy and produces waste products along the way.
- **Enzyme:** A protein that speeds up and controls a specific chemical reaction in the body; enzymes carry out the reactions of metabolism.
- **Metabolic rate:** How fast the body uses energy overall, combining the energy spent at rest with the energy spent on movement and activity.
- **Basal metabolic rate (BMR):** A measure of how quickly the body burns energy while at rest, keeping basic functions such as heartbeat, breathing, and temperature running.
- **Glucose:** A simple sugar produced when carbohydrates are digested; it is a main fuel that cells can use for energy.
- **Nutrient:** A substance in food, such as a carbohydrate, protein, or fat, that the body can use for energy, building materials, or both.

## Eli-10

**Simplified explanation:** Metabolism is the body's engine. It is the sum of every chemical process that keeps you running, from breathing and pumping blood to digesting food and thinking. The engine does two kinds of jobs at once. One crew builds: it takes small pieces from food, like amino acids, and snaps them together into bigger things your body needs, such as muscle. That building work is anabolism. Another crew demolishes: it takes big molecules apart to release energy for the engine, and the leftovers become waste. That breaking-down work is catabolism. The engine also has a speed: metabolic rate is how fast your body uses energy. Basal metabolism is the idle speed, the energy burned just to keep your heart beating and your lungs filling while you rest.

**Analogy:** Picture a city that never sleeps. Food is the fuel delivery, and the power plant burns it to keep the lights on across the whole city. Construction crews raise new buildings from stacks of bricks, which is anabolism. Wrecking crews tear down old buildings and turn them into usable scrap and rubble, which is catabolism. The plant hums along at an idle pace even at 3 a.m., when almost everyone sleeps, and that idle pace is the city's basal metabolism. A bigger city with more working crews, more buildings, and more fuel trucks runs hotter than a small one.

**Where the analogy breaks down:** A power plant can be shut down for maintenance, but the body's metabolism never switches off completely, it keeps working even during deep sleep. The analogy also makes building and demolition look like separate teams with separate sites, while in the body both kinds of reactions run side by side inside nearly every cell, all the time.

## Practice Question Bank

1. **A health teacher asks students to point to everyday examples of metabolism, the body's chemical work. Which list is entirely made of processes that fit the standard definition?**
   - A. Breathing, circulating blood, digesting food
   - B. Sleeping, dreaming, waking up
   - C. Shopping, cooking, cleaning
   - D. Laughing, clapping, waving
   **Answer: A.** MedlinePlus defines metabolism as all the physical and chemical processes that convert or use energy, and its examples include breathing, circulating blood, and digesting food. The other lists describe daily activities or states, not the chemical processes themselves.

2. **After a long bike ride, Nia's body repairs her leg muscles, assembling amino acids from her post-ride meal into new muscle protein. In metabolism vocabulary, this repair work is:**
   - A. Catabolism, because large molecules are being split apart for energy
   - B. Anabolism, because small building blocks are being built into larger molecules
   - C. Digestion, because food is being broken down in the stomach
   - D. Excretion, because waste products are leaving the body
   **Answer: B.** Anabolism is the building-and-storing side of metabolism: small building blocks such as amino acids are assembled into larger molecules like muscle protein. Catabolism is the opposite, breaking large molecules down to release energy, and digestion and excretion are related but different processes.

3. **Two cousins are the same age, height, and weight, but one lifts weights and has noticeably more muscle. Based on what is known about body composition and metabolic rate, which statement is the most accurate?**
   - A. The cousins burn energy at rest at exactly the same rate because they weigh the same
   - B. The less muscular cousin has a higher resting rate because fat conserves energy
   - C. The more muscular cousin generally has a higher basal metabolic rate, because muscle burns more energy at rest than fat does
   - D. Basal metabolic rate is decided at birth and does not differ between two people
   **Answer: C.** Basal metabolic rate is influenced by body composition: people with more muscle and less fat generally have higher resting rates, because muscle burns more energy at rest than fat. Equal weight alone does not mean equal rates, fat does not raise the resting rate, and BMR is not fixed at birth.

4. **A 70-year-old man notices he feels colder at rest than he did at 25, and his doctor explains that his metabolism has slowed with age. Which explanation matches the scientific picture?**
   - A. Metabolism slows with age partly because muscle mass tends to decrease, and muscle burns more energy at rest than fat does
   - B. Metabolism slows with age only because older people happen to eat less
   - C. Metabolism speeds up with age because the body works harder to repair aging cells
   - D. Metabolism does not change with age; only physical activity changes
   **Answer: A.** Metabolism generally slows as people age, and one reason is that muscle mass tends to decrease with age; since muscle burns more energy at rest than fat, less muscle means a lower resting burn. Eating habits, extra repair work, and 'no change at all' are not the stated causes.

5. **Marco eats a meal of bread, chicken, and butter. After digestion, which statement correctly describes what happens to the nutrients his body absorbs?**
   - A. Only the bread is used by the body; the chicken and butter pass through unused
   - B. All three nutrients are converted directly into muscle without any chemical change
   - C. The body stores all absorbed nutrients as fat, regardless of which food they came from
...
- Nemours KidsHealth, Metabolism (for Teens) — https://kidshealth.org/en/teens/metabolism.html (medically reviewed by Larissa Hirsch, MD; reference only)
- National Institute of Diabetes and Digestive and Kidney Diseases (NIH), Weight Management — https://www.niddk.nih.gov/health-information/weight-management (reference only)
...
- **Rights status:** Reference-only sources (MedlinePlus/NLM, Nemours KidsHealth, NIDDK/NIH); no source prose adapted, all wording original.
- **Transformation:** Definitions and process descriptions from MedlinePlus and Nemours KidsHealth were paraphrased into original EliExplains prose; NIDDK corroborates the scientific framing; all examples constructed independently.
