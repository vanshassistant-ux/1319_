...
- **Fats (lipids):** One of the six classes of nutrients; a family of energy-rich molecules built mainly from carbon, hydrogen, and oxygen that store energy and build cell structures.
- **Triglycerides:** The most common form of dietary fat, made of three fatty acids attached to a glycerol backbone; the body's main storage form of fat.
- **Phospholipids:** A form of fat that makes up the membranes surrounding the body's cells.
- **Sterols:** The least common form of dietary fat; cholesterol, the best-known sterol, is found in all cells and helps build hormones.
- **Cholesterol:** A waxy, fat-like sterol found in all the body's cells that the body uses to make hormones, vitamin D, and bile; the body makes what it needs.
- **Saturated fat:** A fat whose fatty acids carry no double bonds, so the molecules pack tightly; usually solid at room temperature, as in butter and fatty meats.
- **Unsaturated fat:** A fat whose fatty acids contain double bonds that kink the chain; usually liquid at room temperature, as in olive and canola oil.
- **Fat-soluble vitamins:** Vitamins A, D, E, and K, which dissolve in fat and need dietary fat in a meal to be absorbed.
...
Where the analogy breaks down: canned goods are inert—they just sit there—but body fat is constantly active, releasing energy, carrying vitamins, and feeding into hormone production. And a pantry suggests one kind of can, yet fats differ by type: saturated fats behave differently from unsaturated fats, which is why the type and amount of fat matter, not just the presence of fat. Nobody panics about having a pantry; the question is what is in it and how much.
...
- **Treating all fat as junk that should be eliminated from the diet.** Fats are essential: the body needs them for cell membranes, hormone building blocks, and absorbing vitamins A, D, E, and K. The goal is the right types in reasonable amounts, not zero fat.
- **Assuming fat-free versions of foods are automatically healthier.** When manufacturers strip fat out, they often add sugar or refined starch to restore taste, trading one energy source for another. Read the whole label rather than the fat line alone.
- **Believing that eating fat directly becomes body fat while carbohydrate and protein do not.** All three nutrients contribute calories—fat just packs more per gram (9 versus 4). Body fat stores extra energy from any source, so the useful questions are total energy balance and the types of fat chosen.
- **Thinking "plant oil" means unsaturated, so all oils are alike.** Coconut and palm oils are plant oils that are high in saturated fat, and most foods contain a mixture of saturated and unsaturated fatty acids. The type of fat is a matter of chemistry, not of food origin alone.
...
**1. One gram of fat supplies about 9 calories. How does that compare with carbohydrate and protein, which each supply about 4 calories per gram?**

- It supplies about the same energy as either one
- It supplies more than double the energy of either one
- It supplies slightly less energy than protein
- It supplies about half the energy of carbohydrate

**Correct answer: It supplies more than double the energy of either one.** At about 9 calories per gram, fat supplies more than double the energy of carbohydrate or protein, which each provide about 4 calories per gram. The other options get the comparison backwards.

**2. Which of the following is the most common form of fat in the body, the storage form made of three fatty acids attached to a glycerol backbone?**
...
**Correct answer: Triglycerides.** Triglycerides are the most common form of fat in food and in the body: three fatty acids on a glycerol backbone, stored in fat cells. Sterols and phospholipids are the other two main forms, and amino acids are protein building blocks, not fats.

**3. After a long day of hiking, Priya's body has used up its quick fuel and begins releasing stored energy from her fat cells. Which form of fat is her body drawing on?**
...
**Correct answer: Triglycerides.** The body stores its energy reserve as triglycerides in fat cells and releases them when energy is needed between meals. Sterols and phospholipids are structural and signaling molecules rather than the body's main fuel reserve.

**4. A friend announces she is cutting all fats out of her diet because she heard fat is unhealthy. Which response is most consistent with the evidence in this lesson?**

- Fats are essential for membranes, hormones, and vitamin absorption, so the goal is the right type and amount, not zero
- She is right, and she should also avoid oils, nuts, and fish to be safe
- She should replace every fatty food with refined carbohydrates, which are healthier
- Only the total calories matter, so the type of fat is irrelevant

**Correct answer: Fats are essential for membranes, hormones, and vitamin absorption, so the goal is the right type and amount, not zero.** Nutrition authorities agree that fats are essential—needed for membranes, hormones, and vitamin absorption—and that the type and amount matter; Harvard's Nutrition Source notes that replacing fat with refined carbohydrates can be its own problem. Cutting all fat removes nutrients the body cannot do without.

**5. Rosa eats a varied diet but almost no fat at all. Which group of vitamins is she most likely to absorb poorly as a result?**

- Vitamin C and the B vitamins
- Vitamins A, D, E, and K
- All vitamins are absorbed exactly the same way
- Vitamins are not affected by dietary fat in any way

**Correct answer: Vitamins A, D, E, and K.** Vitamins A, D, E, and K are fat-soluble: they travel with dietary fat, and meals very low in fat can impair their absorption. Vitamin C and the B vitamins dissolve in water and do not need fat for absorption.

## Sources

- OpenStax Nutrition (Nutrition for Nurses) 2e, Section 2.2: Fats — https://openstax.org/books/nutrition/pages/2-2-fats (read directly, 2026-08-22; also via Wayback capture of 2024-04-12)
- OpenStax Nutrition (Nutrition for Nurses) 2e, Section 1.1: What Is Nutrition? — https://openstax.org/books/nutrition/pages/1-1-what-is-nutrition
- MedlinePlus, Dietary Fats Explained (Medical Encyclopedia) — https://medlineplus.gov/ency/patientinstructions/000104.htm
- MedlinePlus, Triglycerides (Health Topic) — https://medlineplus.gov/triglycerides.html
- MedlinePlus, Cholesterol (Health Topic) — https://medlineplus.gov/cholesterol.html
- LibreTexts, An Introduction to Nutrition (Zimmerman and Snow), 5.2: What Are Lipids — https://med.libretexts.org/Bookshelves/Nutrition/An_Introduction_to_Nutrition_(Zimmerman)/05%3A_Lipids/5.02%3A_What_Are_Lipids
...
- Saturated and Unsaturated Fat (nutrition:foundations:saturated-and-unsaturated-fat)
- Essential Fatty Acids (nutrition:foundations:essential-fatty-acids)
- Energy and Calories (nutrition:foundations:energy-and-calories)
- Fat-Soluble Vitamins (nutrition:foundations:fat-soluble-vitamins)
- Proteins (nutrition:foundations:proteins)

## Editorial Metadata

- Topic ID: nutrition:foundations:fats
- Subject: nutrition / Unit: foundations / Phase: 4
- Editorial status: READY_TO_PUBLISH
- Researched: 2026-08-22
- Evidence packet: editorial/subjects/nutrition/evidence/fats.json
- Review record: content/phase-4/review/nutrition-fats.json
