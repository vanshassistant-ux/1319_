...
Both ends of the mineral spectrum matter. Too little: when iron intake falls short, the body draws on its stored iron, and over time low iron can leave a person tired and anemic; too little calcium over years can weaken bones; and getting too little potassium can raise blood pressure. Too much: most people in the United States get more sodium than they need, and excess sodium can lead to high blood pressure when the kidneys cannot clear it. The general pattern is balance, not maximum. The minerals that help manage fluid balance and nerve signals, such as sodium and potassium, are also known as electrolytes, and their chemistry belongs to a sibling lesson. For the honest framing, this lesson offers a way to think about it: minerals are the body's hardware, the physical structures and machines, and vitamins are its software, the helpers that make the machinery run. Like any analogy it has limits, but it captures the truth that the body needs its minerals built in, not just its vitamins switched on.

## Key Vocabulary

- **Mineral:** An inorganic element the body needs in small amounts to build structure and support function.
- **Macrominerals:** Minerals the body needs in larger amounts, including calcium, sodium, and potassium.
- **Trace minerals:** Minerals the body needs only in tiny amounts, including iron, zinc, and copper.
- **Inorganic:** Not made from carbon-based molecules; minerals are inorganic elements, unlike organic vitamins.
- **Hemoglobin:** The iron-containing protein in red blood cells that carries oxygen from the lungs to the body.
- **Deficiency:** A state of having too little of a nutrient, which can impair body functions over time.
- **Excess:** Having more of a nutrient than the body needs, which can also cause health problems.
- **Electrolyte:** A mineral that helps manage fluid balance and nerve signals, covered in its own lesson.
...
1. Treating all minerals as equal: a label showing 2 milligrams of iron and 300 milligrams of calcium does not mean iron is unimportant. Trace minerals are needed in tiny amounts, and tiny is not the same as optional.
2. Assuming more is always better: excess matters, as the sodium example shows. The goal for minerals is balance, not maximum.
3. Thinking minerals come mainly from pills: most people get the minerals they need from a wide variety of ordinary foods, and the supplements lesson owns the pill discussion.
4. Blaming one mineral for a whole problem: jobs overlap, since calcium and sodium both support nerve function, so no mineral works alone.
5. Confusing minerals with vitamins: vitamins are organic compounds, while minerals are inorganic elements, and each group has its own lesson.

## Practice Question Bank

**Minerals divide into two groups by the amount the body needs. Which group is needed in larger amounts?**

A. Macrominerals
B. Trace minerals
C. Fat-soluble minerals
D. Water-soluble minerals

**Correct answer:** A

*Macrominerals, such as calcium, sodium, and potassium, are the minerals the body needs in larger amounts. Trace minerals like iron are needed in only tiny amounts, and fat-soluble and water-soluble are categories of vitamins, not minerals.*
...
A. All three are trace minerals because each serving contains only small amounts
B. Calcium and potassium are macrominerals, while iron is a trace mineral
C. All three are macrominerals because each one appears in the food
D. Iron is a macromineral because the body stores it in the bones

**Correct answer:** B

*The mineral groups are set by the amount the body needs, not the amount in one serving. The body needs calcium and potassium in larger amounts (macrominerals), while iron is a trace mineral needed in tiny amounts.*
...
*Iron is used to make hemoglobin, the protein in red blood cells that carries oxygen from the lungs to all parts of the body. Calcium builds bone, potassium supports nerve and heart function, and sodium helps with fluid balance.*

**A coach tells runners that two minerals that help keep the right balance of fluids in the body are lost in sweat during hard exercise. Which pair of minerals is the coach describing?**
...
*Sodium helps keep the right balance of fluids in the body, and potassium supports kidney and heart function tied to that balance. Iron, zinc, copper, and manganese have other jobs, and calcium and phosphorus are bone minerals.*

**One friend has eaten mostly the same three foods for months; another eats a wide variety of foods from all food groups. Based on what nutrition science says about minerals, which statement is most accurate?**

A. The friend with the varied diet is more likely to get the mix of minerals her body needs
B. The friend with three foods is safer because repeating foods prevents mineral excess
C. Variety matters for vitamins but not for minerals
D. Diet makes little difference because the body makes the minerals it needs
...
- Minerals (Health Topics), National Library of Medicine / MedlinePlus, https://medlineplus.gov/minerals.html
- Calcium Fact Sheet for Consumers, NIH Office of Dietary Supplements, https://ods.od.nih.gov/factsheets/Calcium-Consumer/
- Iron Fact Sheet for Consumers, NIH Office of Dietary Supplements, https://ods.od.nih.gov/factsheets/Iron-Consumer/
- Potassium Fact Sheet for Consumers, NIH Office of Dietary Supplements, https://ods.od.nih.gov/factsheets/Potassium-Consumer/
- Sodium (Health Topics), National Library of Medicine / MedlinePlus, https://medlineplus.gov/sodium.html
