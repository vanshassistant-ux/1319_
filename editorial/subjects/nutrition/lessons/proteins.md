...
- **Proteins** — One of the six classes of nutrients; large molecules made of chains of amino acids, found in meat, fish, eggs, dairy, legumes, and nuts.
- **Amino acids** — The small units that link together in chains to build proteins; the body breaks dietary protein down into them and rebuilds them into new proteins.
- **Essential amino acids** — The amino acids the body cannot make on its own, so they must come from food; their details are covered in the amino acids lesson.
- **Complete protein** — A food protein that contains all the essential amino acids, such as a hard-boiled egg or a fillet of halibut.
- **Incomplete protein** — A food protein missing one or more essential amino acid, such as a slice of wheat bread or a bowl of pinto beans eaten alone.
- **Enzyme** — A protein that powers a chemical reaction in the body; nearly all of the body's thousands of reactions depend on them.
- **Hormone** — A messenger chemical that carries signals between cells, tissues, and organs; some hormones are proteins.
- **Hemoglobin** — The protein in red blood cells that binds and carries oxygen from the lungs to the rest of the body.
...
Where the analogy breaks down: LEGO bricks are interchangeable and reusable at no cost, but amino acids are not all the same. Nine of them, the essential amino acids, must come from food because the body cannot build them. And if you burn LEGO bricks for heat, you run out of pieces to build with; the same is true when the body breaks down its own protein for fuel. It works, but it costs tissue that had other jobs. The analogy also suggests bricks sit in a storage bin, yet the body does not stockpile protein at all.

## Practice Question Bank

**1. According to the working definition used in nutrition science, what are proteins?**

- Droplets of stored fat the body keeps for insulation
- Large molecules made of chains of amino acids
- Sugary compounds the body breaks down for quick energy
- Mineral crystals that give bones their hardness

**Correct answer: Large molecules made of chains of amino acids.** The working definition is that proteins are large molecules made of chains of amino acids, and every cell in the body contains them. The other options describe fat, carbohydrate, and minerals instead.

**2. About how many calories does one gram of protein provide?**
...
- An apple with a handful of raisins
- Grilled chicken with a glass of milk

**Correct answer: Grilled chicken with a glass of milk.** Chicken is poultry and milk is dairy, so both are protein foods. The other meals are built mainly around carbohydrate: grains, fruits, and juices.

**4. Priya is cooking for relatives who eat only plant foods. Which plate is most likely to supply all the essential amino acids her family needs?**

- Lentil curry with brown rice and a small handful of almonds
- White rice with a glass of apple juice
- A salad of lettuce, cucumber, and tomato
- A single slice of wheat bread with jam

**Correct answer: Lentil curry with brown rice and a small handful of almonds.** Combining legumes, grains, and nuts across a meal supplies all the essential amino acids, as the sources teach. The other plates are too narrow: rice with juice, a leafy salad, and bread alone each fall short of the needed lineup.

**5. During a long stretch without food, the body can break down its own protein to make energy. Why do the sources in this lesson treat that as a fallback rather than the ideal?**

- Protein cannot be converted into usable energy at all
- The body prefers carbohydrate and fat as fuel, so burning protein costs tissue that had building and repair jobs
- Burning protein produces energy but wastes water
...
- National Library of Medicine / MedlinePlus, Protein in Diet (Medical Encyclopedia) — https://medlineplus.gov/ency/article/002467.htm
- National Library of Medicine / MedlinePlus (Genetics), What are proteins and what do they do? — https://medlineplus.gov/genetics/understanding/howgeneswork/protein/
