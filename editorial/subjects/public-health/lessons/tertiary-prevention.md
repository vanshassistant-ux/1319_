...
Tertiary prevention is the level of prevention that acts after disease or injury has occurred. Where primary prevention stops problems before they start and secondary prevention catches them early, tertiary prevention manages what remains: rehabilitation rebuilds ability, support programs steady daily life, and careful management holds off complications. Its goal is limiting disability and protecting quality of life, helping people live as fully as they can with the health they have.
...
- **Tertiary prevention:** The level of prevention that acts after disease or injury has occurred, reducing harm and protecting quality of life.
- **Rehabilitation:** A set of interventions designed to optimize functioning and reduce disability in people with health conditions.
- **Disability:** A limitation in functioning, such as difficulty walking, speaking, or caring for oneself, that can follow illness or injury.
- **Quality of life:** How fully a person can take part in the activities and roles that matter to them, such as work, family, and recreation.
- **Support program:** An organized program that helps people manage an ongoing condition, such as a diabetes education group or a stroke-survivor support group.
- **Complications:** Additional health problems that can develop because of an existing illness, such as a foot infection in a person with diabetes.
- **Primary prevention:** The level of prevention that acts before a health problem starts, removing risks so the problem never develops.
- **Secondary prevention:** The level of prevention that finds a health problem early, while it is still symptom-free and easier to treat.
...
1. **Thinking tertiary prevention only begins when a disease is severe or at its end stage.**
   - *Correction:* Tertiary prevention begins as soon as a condition is established and lasting, even early in an ongoing illness. Its job is limiting further harm from that point on, not waiting for the worst.
2. **Calling tertiary prevention just 'treatment' and therefore not prevention at all.**
   - *Correction:* Treatment addresses the immediate illness, while tertiary prevention is the longer arc of care, rehabilitation, support, and complication management, that reduces disability and protects quality of life. The WHO glossary counts reducing the consequences of established disease as prevention.
3. **Believing that needing tertiary prevention means the earlier levels failed or someone gave up.**
   - *Correction:* Many conditions cannot yet be prevented or caught early enough. Tertiary prevention is a normal, valuable level of public health, not a consolation prize, and it is built for exactly this situation.
4. **Assuming tertiary prevention is only physical rehabilitation delivered in hospitals.**
   - *Correction:* It also includes support programs and complication management, and it happens in homes, schools, workplaces, and community centers, wherever people live their lives.
5. **Confusing tertiary prevention with screening and early detection.**
   - *Correction:* Screening belongs to secondary prevention, which finds a silent problem early. Tertiary prevention acts on a condition that is already established, to limit its damage.

## Compare / Contrast

- **Primary prevention** vs **Tertiary prevention**: Primary prevention acts before a health problem exists, removing risks so it never starts; tertiary prevention acts after disease or injury is established, limiting disability and protecting quality of life.
- **Secondary prevention** vs **Tertiary prevention**: Secondary prevention finds a silent problem early, when it is easier to treat; tertiary prevention manages a condition that is already established and lasting, to prevent further decline.
- **Treatment** vs **Tertiary prevention**: Treatment addresses the immediate illness or injury; tertiary prevention is the organized follow-through, rehabilitation, support programs, and complication management, that reduces long-term disability and protects quality of life.
...
1. **According to the WHO Health Promotion Glossary of Terms, tertiary prevention aims to:**
   - A. Soften the impact of an ongoing illness or injury that has lasting effects, improving function, quality of life, and life expectancy.
   - B. Remove risk factors before any disease develops, so the problem never starts.
   - C. Detect a silent disease through screening, while it is still symptom-free.
   - D. Provide comfort care at the end of life for people who cannot recover.

   **Answer: A.** The WHO glossary describes tertiary prevention as softening the impact of ongoing illness or injury with lasting effects, helping people manage long-term problems to improve function, quality of life, and life expectancy. Removing risk factors is primary prevention, screening is secondary prevention, and end-of-life comfort care is not what tertiary prevention means.

2. **A 62-year-old man had a stroke six weeks ago. He can walk with a cane but struggles with balance and cannot yet return to his job. His care team sets up physical therapy, speech therapy, and a stroke-survivor support group. Which level of prevention is this team practicing?**
   - A. Primary prevention, because the team is removing the causes of stroke from his life.
   - B. Secondary prevention, because the team is screening him for a second stroke.
   - C. Tertiary prevention, because the team is managing an established condition to limit disability and support recovery.
   - D. Treatment only, because prevention ended the moment the stroke happened.

   **Answer: C.** The stroke is already established and lasting, so the team's work, physical therapy, speech therapy, and peer support, is tertiary prevention: limiting disability and preventing further decline. Nothing is being prevented before onset, which would be primary, and nothing is being detected early, which would be secondary.

3. **Which scenario best shows tertiary prevention, and why?**
   - A. A city installs brighter lights at crosswalks so pedestrians are not hit by cars, because the risk is removed before any injury.
   - B. A clinic offers free mammograms to women in their forties, because the test finds breast cancer before symptoms appear.
   - C. A warehouse replaces its heavy steel ladders with lighter non-slip ones, because no worker has been hurt yet.
   - D. A community center runs a fall-prevention exercise class for older adults who have already fallen and fractured a hip, because the goal is limiting further disability.

   **Answer: D.** The fall-prevention class acts after injury is established, rebuilding strength and balance so the person does not fall again: that is tertiary prevention, which limits disability and prevents further decline. The other options act before onset or in the early silent stage, which are primary and secondary prevention.

4. **Why do public health texts describe tertiary prevention as the safety net of the prevention system?**
   - A. Because it is only practiced in hospitals, where safety equipment is available.
   - B. Because it catches people when the earlier levels could not prevent or fully stop harm, so the damage still gets limited.
   - C. Because it costs less than every other form of health care.
   - D. Because it applies only to injuries, never to chronic diseases.

   **Answer: B.** Tertiary prevention is the safety net because some diseases cannot yet be prevented and some are found late, so harm happens; tertiary prevention limits that harm and prevents further decline. It is not limited to hospitals or injuries, and cost is not the defining reason it exists.

5. **A person with diabetes attends a community program where educators help with meal planning and blood-glucose monitoring skills, and members encourage one another between sessions. This program is best described as:**
   - A. A support program, a tertiary-prevention tool that helps people manage an ongoing condition and protect their quality of life.
   - B. Primary prevention, because the program stops diabetes from ever developing.
   - C. Screening, because the program looks for diabetes before symptoms appear.
   - D. End-of-life care, because the program assumes the person cannot manage alone.

   **Answer: A.** The person already has diabetes, an established condition, and the program helps them manage it day to day, which is the support-program tool of tertiary prevention. It does not stop diabetes before onset, which would be primary, does not test for hidden disease, which would be screening, and is not end-of-life care.
...
- World Health Organization, "Rehabilitation" (fact sheet, 22 April 2024) — https://www.who.int/news-room/fact-sheets/detail/rehabilitation (reference-only)
...
- [Primary Prevention](primary-prevention.md)
- [Secondary Prevention](secondary-prevention.md)
- [Health Promotion](health-promotion.md)
- [Community Health](community-health.md)

## Editorial Metadata

- Topic ID: `public-health:foundations:tertiary-prevention`
