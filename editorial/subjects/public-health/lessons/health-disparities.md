...
- **Health disparity** — An avoidable, measurable difference in health outcomes between groups of people, closely tied to social, economic, or environmental disadvantage.
- **Population group** — A set of people who share a characteristic used in health data, such as race or ethnicity, income level, disability status, gender identity, or where they live.
- **Life expectancy** — The average number of years people in a group can expect to live; disparities in life expectancy show up as gaps between groups.
- **Incidence** — The number of new cases of a condition in a group over a period of time; it is one of the rates compared when measuring disparities.
- **Prevalence** — The total number of existing cases of a condition in a group at a given time; it is another of the rates compared when measuring disparities.
- **Health care access** — Whether people can get health care when they need it, including having insurance, transportation, and available providers.
- **Social determinants of health** — The conditions in which people are born, grow, live, work, and age; they are a major driver of health disparities and a sibling topic of this lesson.
- **Bias** — Preconceived attitudes or stereotypes that can shape decisions and treatment; systemic bias is named by Healthy People 2030 as a contributor to disparities.
- **Health equity** — The goal of the highest level of health for all people, pursued by eliminating health disparities; it is a sibling topic of this lesson.
...
**Analogy.** Think of two gardens planted with the same seeds. One gets steady sun, good soil, and regular water; the other sits in shade with thin soil. When the first garden blooms and the second struggles, you do not conclude that the second garden's seeds are weaker. You look at the growing conditions. A health disparity is the difference in the harvest; the growing conditions are the social determinants, bias, and access that shaped it.

**Where the analogy breaks down.** People are not passive plants. People respond, adapt, and act within their conditions, and communities change their own circumstances. Also, the same conditions affect different people differently, so a single garden picture can hide as much as it shows. The comparison is a starting point, not a full explanation.

## Practice Question Bank

1. The fictional towns of Eastmere and Westbrook sit a few miles apart. For ten straight years, Eastmere residents have had higher rates of preventable hospitalizations than Westbrook residents, and officials call the gap a health disparity. Which phrase best captures what they mean?
   - A. A measurable, avoidable difference in health outcomes between groups, closely linked with disadvantage
   - B. A difference in health outcomes caused entirely by genetics
   - C. An outbreak of an infectious disease spreading between the towns
   - D. A billing error in one town's hospitals

2. A public health class is listing the group dimensions along which health disparities are measured. Which list is accurate?
   - A. Hair color, shoe size, and favorite hobby
   - B. Blood type, birth month, and dominant hand
   - C. Race and ethnicity, income, geography, disability, and gender identity
   - D. Astrological sign, height, and musical taste

3. The fictional town of Riverton offers free diabetes screenings and records how many new cases appear in its northern and southern districts separately. What is the health department doing when it compares the two districts' rates?
   - A. Diagnosing an individual patient
   - B. Measuring a disparity by comparing rates between groups
   - C. Quarantining a contagious disease
   - D. Setting prices for hospital services

4. A community health team in the fictional city of Port Haven wants to understand why one district has higher rates of heart disease than the rest of the city. Which factor is a recognized driver of health disparities?
   - A. The phase of the moon during harvest
   - B. The color of residents' front doors
   - C. Which sports team residents cheer for
   - D. Limited access to health care

5. A data analyst finds that residents of one fictional county live several years less, on average, than residents of a neighboring county. Following the honest framing of this lesson, how should the analyst read the finding?
   - A. As a signal that outcomes diverge, and a starting point for investigating why
...
- Healthy People 2030 (HHS), Health Equity in Healthy People 2030 — https://health.gov/healthypeople/priority-areas/health-equity-healthy-people-2030 (read via Internet Archive capture, 2022-04-07)
- NIMHD, National Institutes of Health, What Are Health Disparities? — https://www.nimhd.nih.gov/about/what-are-health-disparities
- MedlinePlus, U.S. National Library of Medicine, Health Disparities — https://medlineplus.gov/healthdisparities.html
