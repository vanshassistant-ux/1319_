...
Prevalence is the total number of existing cases of a disease in a population at a given time — the people living with the condition, not the people newly getting it. Point prevalence counts one moment; period prevalence counts a window of time. Prevalence shows the total burden of disease. New cases, recoveries, deaths, and migration all change it. Measuring it means counting current cases and dividing by the population. Prevalence is a snapshot; incidence, its sibling topic, is the movie.
...
- **Prevalence** — The total number of existing cases of a disease or condition in a population at a given time, usually stated as a proportion or percentage of the population.
- **Point prevalence** — Prevalence measured at a single moment, such as the proportion of people with the condition on one particular date.
- **Period prevalence** — Prevalence measured over a window of time, counting everyone with the condition at any point during the window.
- **Incidence** — The number of new cases of a condition that appear in a population during a period of time; it is a sibling topic of this lesson, and prevalence counts new and preexisting cases while incidence counts only new ones.
- **Existing case** — A person currently living with the condition being counted, whether the condition began last week or years ago.
- **Population** — The group of people being counted, such as the residents of a town, the students of a school, or the adults of a country.
- **Burden of disease** — The total impact of a health condition on a population; prevalence describes it by showing how many people are living with the condition at a given time.
- **Survey** — A common way of measuring prevalence, in which a population is asked or tested to count who has the condition, with the count divided by the total number of people.
...
**Analogy.** Think of a busy highway. Prevalence is a photograph of the road at this moment: how many cars are on it right now. Incidence is the flow — how many cars merge onto the highway during an hour. Cars leave when their trips end, which stands for recovery, or when they break down, which stands for death. If trips get longer, more cars sit on the road at any moment even when the same number enters each hour, just as longer survival keeps more people living with a disease.

**Where the analogy breaks down.** The highway analogy has limits. A car trip lasts minutes, but a chronic condition can last decades, and some diseases end in recovery while others never do. Traffic also treats every car alike, while diseases differ in severity and duration. The comparison is a way to see the difference between a count and a flow, not a model of any single disease.

## Practice Question Bank

1. The fictional county of Lakeport reports that the prevalence of asthma among its residents is 6 percent. Which meaning is closest to what the report is saying?
   - A. Six percent of residents are living with asthma at the time the count was made, whether diagnosed last week or years ago
   - B. Six percent of residents were newly diagnosed with asthma this year
   - C. Six percent of residents died from asthma this year
   - D. Six percent of hospital beds are occupied by asthma patients

2. On June 1, a health team in the fictional town of Millfield visits every school and counts every student currently living with the condition being studied, on that single day. What did the team measure?
   - A. Period prevalence, because the count covered a window of time
   - B. Point prevalence, because the count was made at one moment in time
   - C. Incidence, because it counted new cases only
   - D. A death rate, because it tracked outcomes over the year

3. In the fictional town of Ashgrove, a survey finds 50 of 1,000 residents living with a condition. A year later, after some residents without the condition moved away, a new survey finds 50 of 800 residents with the same condition. What happened to the prevalence?
   - A. It stayed the same, at 5 percent
   - B. It fell, from 5 percent to 4 percent
   - C. It rose, from 5 percent to 6.25 percent
   - D. It cannot be determined from the information given

4. A reporter notes that the prevalence of diabetes in a fictional county has been flat for three straight years and writes that 'nothing is changing.' A public health officer reads the claim. Following the honest framing of this lesson, which response is correct?
   - A. A flat prevalence proves that no one is getting diabetes anymore
   - B. A flat prevalence proves that diabetes has been eliminated from the county
   - C. A flat prevalence proves that new cases must be falling
   - D. The snapshot can stay level while new cases rise and people live longer with diabetes, so the claim goes beyond what prevalence shows

5. The clinic at a fictional nursing home records every resident who had arthritis at any time during the past year, including residents who were diagnosed many years earlier and are still living with the condition. Which measure did the clinic produce?
   - A. Period prevalence, the proportion of residents with the condition at any time during the interval
...
- CDC, Principles of Epidemiology in Public Health Practice, Third Edition, Lesson 3, Section 2: Morbidity Frequency Measures — https://archive.cdc.gov/www_cdc_gov/csels/dsepd/ss1978/lesson3/section2.html (read via archive.cdc.gov, the CDC's official archive host)
- World Health Organization, Global Health Observatory, Indicator Metadata Registry: Diabetes prevalence — https://www.who.int/data/gho/indicator-metadata-registry/imr-details/3356
- National Institute of Mental Health (NIH), Mental Illness (Statistics) — https://www.nimh.nih.gov/health/statistics/mental-illness
