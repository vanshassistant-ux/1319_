...
A persona is a fictional but realistic profile of a user type, built from real research data. It is a composite portrait: one made-up person — with a name, an age, a job, goals, and frustrations — who stands in for a cluster of real users with similar behaviors and needs. Personas keep a design team focused on a concrete user instead of a vague crowd, give the team a shared shorthand, and are revised whenever new research arrives.
...
Teams keep the persona set small. NN/g emphasizes that personas must stay memorable, actionable, and distinct from one another, and that keeping tens of user types in mind while designing would quickly become unwieldy; the IxDF makes the same point in fewer words — the more personas you have, the more focus you lose. In practice, most teams settle on a small set of three to five personas, with one primary persona anchoring the design and secondary personas covering important variations. The set is not permanent. NN/g’s survey of 156 companies shows revision practice varies widely, and its guidance is to revise personas when the business or technology changes significantly or when new research shows the user base has shifted. The farmers-market team started with three personas — Owen, Dev, and Marta — and planned to revisit them after a survey of two hundred shoppers.

## Key Vocabulary

- **Persona** — A fictional but realistic profile of a user type, synthesized from research about real users.
- **User type** — A cluster of real people who share similar goals, behaviors, and needs toward a product.
- **Composite portrait** — A single character assembled from the common traits of many real people.
- **Demographics** — Basic descriptive facts about a person, such as age, occupation, and where they live.
- **Frustrations** — The pain points and annoyances a user experiences that a product could help remove.
- **User research** — The systematic gathering of evidence about real users through methods like interviews and surveys.
- **Stereotype** — A fixed, oversimplified belief about a group of people that is held without evidence.
- **Primary persona** — The main persona a design focuses on, with other personas treated as secondary.
- **Empathy** — The ability to understand and share how another person feels, which personas are designed to support.
...
- **Inventing a persona straight from imagination — “we know our users, just write one up.”** Personas must be based on research. Without data you have a stereotype with a name. Start with user research, even a small round of interviews, before writing a persona.
- **Packing a persona with colorful but irrelevant details, like a favorite movie or car.** Keep only details that could change a design decision. NN/g’s rule is to remove anything that would not affect the final design.
- **Creating one persona for every stakeholder or market segment, ending up with fifteen.** A large set is unmemorable and unfocused. Keep the set small — commonly three to five — with one primary persona anchoring the design.
- **Expecting a real person to match a persona exactly, or treating a persona as a substitute for testing.** A persona represents a type, not an individual, and is a thinking tool, not proof. Real users still need to test the product.

## Compare / Contrast

- **Persona vs. Stereotype** — A persona is a research-based tool representing a user type that gets revised when evidence changes; a stereotype is a fixed, oversimplified belief held without evidence.
- **Persona vs. Jobs-to-be-done** — A persona describes who the user is — goals, behaviors, frustrations; a jobs-to-be-done describes what job the user is hiring the product to do. They are compatible and answer different questions.
- **Persona vs. Archetype** — Both summarize the same research clusters, but a persona presents the type as a single named human character, while an archetype uses an abstract label without a name or face.
...
- C. A detailed biography of a real customer the team interviewed
- D. A list of every feature the product team plans to build

**Correct answer: B.** The working definition, attributed to the Nielsen Norman Group, is that a persona is a fictional but realistic description of a typical or target user of the product, built from research. It is not statistics, not a real individual's biography, and not a feature list.

**2. Which statement states the core rule of persona creation?**

- A. Personas should reflect the design team's best guesses about who uses the product.
- B. Personas should include as many demographic details as possible, regardless of relevance.
- C. Personas work best when each team member writes their own.
- D. Personas must be based on user research, because they are made-up people built from information about real people.

**Correct answer: D.** The core rule is that personas are research-based: NN/g notes that personas might be made-up people, but they should be based on information about real people. Guesses, irrelevant demographic detail, and individual authorship all violate that rule.

**3. The Market Mornings team is choosing between a loyalty-points program and a produce pre-order feature. Owen, their primary persona, is a weekly shopper whose goals are speed and a guaranteed basket and whose main frustration is running out of time. Which decision follows from the personas?**

- A. Build the loyalty-points program, since it encourages repeat visits.
- B. Build both features, since every user wants everything.
- C. Build the pre-order feature first, because it answers Owen's goals and frustrations directly.
- D. Abandon the app, since Owen represents only one user type.

**Correct answer: C.** Applying the persona means checking the feature against Owen's goals and frustrations. Pre-ordering answers his need for speed and a guaranteed basket; points do not. Personas make the trade-off visible rather than deciding it alone.

**4. A stakeholder says the app should not bother supporting older users because “older people can't use apps.” The research behind the persona Marta — 67, a retired bookkeeper who texts daily and books travel online — contradicts that claim. Which statement best analyzes the situation?**

- A. The stakeholder is relying on a stereotype, while Marta is a research-based persona; the team should let the evidence, not the stereotype, guide design.
- B. The stakeholder is right, because most older adults avoid technology.
- C. Marta proves that every older adult is a confident app user.
- D. The team should remove Marta from the persona set to avoid conflict.

**Correct answer: A.** A stereotype is a fixed, oversimplified belief held without evidence, whereas a persona is built from research. Marta does not prove anything about all older adults — she represents what the research showed — but the design decision should follow the evidence, not the stereotype.

**5. Why do teams keep their persona set small — commonly three to five — with a single primary persona?**

- A. Because personas must stay memorable, actionable, and distinct, and more personas mean less focus.
- B. Because a project may only ever have five real users.
- C. Because guidelines require exactly one persona per feature.
- D. Because small sets are cheaper to invent without research.

**Correct answer: A.** NN/g stresses that personas must be memorable, actionable, and distinct, and that designing with tens of user types in mind becomes unwieldy; the IxDF adds that the more personas you have, the more focus you lose. One primary persona anchors the design.

## Sources

- Nielsen Norman Group — [Personas Make Users Memorable for Product Team Members](https://www.nngroup.com/articles/personas-why/)
...
- Nielsen Norman Group — [Revising Personas](https://www.nngroup.com/articles/revising-personas/)
- Nielsen Norman Group — [Personas vs. Archetypes](https://www.nngroup.com/articles/personas-archetypes/)
- Nielsen Norman Group — [Persona Types](https://www.nngroup.com/articles/persona-types/)
- Interaction Design Foundation — [Personas (topic encyclopedia entry)](https://www.interaction-design.org/literature/topics/personas)
- Interaction Design Foundation — [Personas: Why and How You Should Use Them](https://www.interaction-design.org/literature/article/personas-why-and-how-you-should-use-them)

## Related Topics

- [User Research](ux-ui-design:foundations:user-research)
- [Interviews](ux-ui-design:foundations:interviews)
- [Surveys](ux-ui-design:foundations:surveys)
- [Jobs-to-be-Done](ux-ui-design:foundations:jobs-to-be-done)
- [User Journeys](ux-ui-design:foundations:user-journeys)

## Editorial Metadata

- **Topic id:** ux-ui-design:foundations:personas
- **Subject / unit / slug:** ux-ui-design / foundations / personas
...
- **Sources cited:** nng-personas-make-users-memorable, nng-why-personas-fail, nng-personas-jobs-be-done, nng-revising-personas, nng-personas-archetypes, nng-persona-types, ixdf-what-are-personas, ixdf-personas-simple-introduction
