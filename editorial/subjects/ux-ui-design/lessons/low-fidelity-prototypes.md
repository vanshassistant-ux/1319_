...
A low-fidelity prototype is a rough, quickly made representation of a design that tests ideas before any code is written. It can be a paper sketch, a simple clickable flow, or screens filled with placeholder content. Because it is cheap to build, it is also cheap to change — so teams test the idea while fixing it still costs almost nothing. Low-fidelity prototypes are built to test layout, flow, and structure, not visual polish, exact spacing, or real content.
...
The honest framing is that fidelity is a tool you choose, not a ladder you climb. The Interaction Design Foundation advises designers to choose the fidelity level that fits their goals and stage of development — the level of fidelity should be appropriate for the feedback they need. The Nielsen Norman Group says the choice of prototype depends on the goals of the testing, the completeness of the design, and the resources available. The rule of thumb: test structure with rough, test polish with refined. If the question is "does the order of steps make sense?", a paper sketch answers it as well as a finished build would. If the question is "does this look ready to launch?", no sketch can answer it — that is a job for a high-fidelity prototype, which has its own lesson. Matching fidelity to the question is what keeps prototyping fast instead of wasteful.

## Key Vocabulary

- **low-fidelity prototype** — A rough, quickly made representation of a design, built to test ideas before any code is written.
- **fidelity** — How closely a prototype matches the look and feel of the final product; fidelity can vary in interactivity, visuals, and content.
- **paper prototype** — A low-fidelity prototype made of hand-drawn screens on paper or cards, often operated by a person who swaps pages as the user interacts.
- **placeholder content** — Stand-in text, images, or labels used in a prototype instead of the real thing, such as a gray box marked "photo" or a line reading "headline goes here."
- **clickable flow** — A small set of rough screens linked together so a user can click through the main path of a task.
- **layout** — Where elements sit on a screen; one of the structural things a low-fidelity prototype is built to test.
- **flow** — The order of steps a person moves through to complete a task; one of the structural things a low-fidelity prototype is built to test.
- **high-fidelity prototype** — A refined prototype that closely resembles the final product, used to test polish; it has its own lesson in this course.
...
- **Mistake:** Skipping low fidelity and waiting until the design "looks good enough" to show anyone.
  - **Correction:** Show the rough version early. The Nielsen Norman Group warns that if you wait, it is too late to translate what you learn into changes in the design's direction — and a sketch that fails costs almost nothing.
- **Mistake:** Using a low-fidelity prototype to judge visual polish, exact spacing, or real content.
  - **Correction:** Use low fidelity for layout, flow, and structure. Questions about colors, pixel spacing, and real copy belong to a refined prototype, which has its own lesson.
- **Mistake:** Polishing the prototype — adding detailed drawings, real photos, and careful spacing — before testing.
  - **Correction:** Keep it rough on purpose. Roughness keeps the team willing to change the design and signals to stakeholders that the work is not finished.
- **Mistake:** Expecting a low-fidelity test to answer every question about the design.
  - **Correction:** A rough prototype answers structural questions — layout, flow, and order of steps. The honest framing is that fidelity should match the question: rough for structure, refined for polish.

## Compare / Contrast

- **Low-fidelity prototype vs. High-fidelity prototype:** Low fidelity is rough, fast, and cheap, built to test structure; high fidelity is refined and closely resembles the final product, built to test polish. High-fidelity prototypes have their own lesson.
- **Paper sketch vs. Simple clickable flow:** A paper sketch is static — a person plays the computer and swaps pages by hand; a clickable flow lets users advance screens themselves. Both stay low fidelity as long as the visuals and content remain rough.
- **Wireframe vs. Low-fidelity prototype:** A wireframe is a static diagram of layout and content placement, while a low-fidelity prototype is built to be tested by people moving through a task. Wireframes have their own lesson.
...
1. Which statement best describes a low-fidelity prototype?
   ...
   D. A detailed mockup with real photos and final text
   **Answer: A.**

2. A designer draws a checkout flow on index cards. During a test, a teammate sits nearby and swaps in the next card whenever the shopper taps a button on the paper screen. What is the teammate doing?
   A. Writing code for the final product
   B. Taking notes for the marketing team
   C. Playing the part of the computer in a paper prototype test
   D. Testing the visual design of the checkout screen
   **Answer: C.**

3. Which question is a low-fidelity prototype best suited to answer?
   A. Does the shade of green match the brand guidelines?
   B. Is the final headline copy persuasive?
   C. Are the buttons spaced exactly 24 pixels apart?
   D. Does the order of steps in the sign-up flow make sense?
   **Answer: D.**

4. A team has two questions about a new recipe app: whether the "add ingredient" step belongs before or after "choose servings," and whether the home screen looks polished. How should the team test?
   A. Test both questions with a single paper sketch
   B. Test the step order with a rough prototype and leave the polish question for a refined prototype
   C. Test the polish question first, because visuals matter most
   D. Skip testing and rely on the team's experience
   **Answer: B.**

5. During a paper prototype test, a stakeholder looks at the sketch and complains that the spacing looks two pixels off. Why is this feedback not useful at this stage?
   A. The stakeholder is right, and the sketch should be corrected immediately
   B. Paper prototypes are meant to test final typography and spacing
   C. A low-fidelity prototype does not represent exact spacing, and the test is about structure, not pixels
   D. The designer should switch to a high-fidelity tool before any more testing
   **Answer: C.**

## Sources

- **nngroup-ux-prototypes-hi-lo-fidelity**
...
- **Topic:** ux-ui-design:foundations:low-fidelity-prototypes
- **Editorial status:** READY_TO_PUBLISH
- **Researched:** 2026-08-21
- **Rights:** Reference-only sources; no source prose adapted; all examples original.
- **Transformation:** Working definition synthesized from NN/g's prototype-as-hypothesis framing and IxDF's definition of prototypes as early models; fidelity dimensions, the paper-prototype 'computer' method, the low-fidelity benefits, and Nielsen's early-vs-late estimates grounded in two Nielsen Norman Group articles; forms (paper sketches, simple clickable flows, placeholder content), strengths and limits, and the fidelity-matches-the-question framing grounded in NN/g and IxDF. All examples and scenarios are original.
