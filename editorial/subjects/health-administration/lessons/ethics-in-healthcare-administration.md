...
- **Clinical ethics** — The branch of healthcare ethics concerned with the right course of action for an individual patient's care.
- **Organizational ethics** — The branch concerned with the right conduct of a healthcare institution and its managers in policy, finance, and operations.
- **Respect for autonomy** — The principle of honoring a competent person's capacity to make informed decisions about their own care.
- **Beneficence** — The principle of acting to promote the well-being and best interests of the people served.
- **Non-maleficence** — The principle of avoiding and preventing harm, expressed in the maxim to first do no harm.
- **Justice** — The principle of distributing benefits, burdens, risks, and costs fairly across patients and communities.
- **Fiduciary duty** — An obligation to act in the interest of those one serves, rather than for personal gain, when entrusted with their resources or welfare.
- **Stewardship** — Responsible management of finite resources held on behalf of patients, the organization, and the public.
- **Conflict of interest** — A situation in which a personal or outside stake could improperly influence a decision owed to patients or the organization.
- **Ethics committee** — A standing group that provides consultation, policy review, and education on ethical questions within a healthcare organization.
...
- **Treating administrative ethics as identical to bedside clinical ethics.** Clinical ethics concerns the individual patient's care; organizational ethics concerns the institution's policies, finances, and conduct. Administrators are accountable for the systems within which clinical decisions happen.
- **Attributing the four principles to the Hippocratic Oath or to no one in particular.** Respect for autonomy, beneficence, non-maleficence, and justice were articulated as a framework by Beauchamp and Childress in *Principles of Biomedical Ethics* (1979). Non-maleficence echoes the Hippocratic tradition, but the four-principle framework is theirs.
- **Assuming a professional code or an ethics framework gives one correct answer to every dilemma.** The principles are prima facie and can conflict; codes set standards and processes but do not adjudicate genuine value conflicts. The ethical task is a defensible, transparent trade-off, not a formula.
- **Confusing an ethical question with a purely legal or financial one.** Compliance and profitability are constraints, not the whole of ethics. A choice can be legal and profitable yet still fail duties of justice, transparency, or stewardship.
- **Confusing the Belmont Report's research-ethics principles with clinical care standards.** The Belmont Report (1979) sets principles for research on human subjects, respect for persons, beneficence, and justice, and underlies institutional review boards. It is not a general standard for routine patient care.

## Compare / Contrast

- **Clinical ethics** vs **Organizational ethics** — Clinical ethics resolves the right action for one patient, often via a bedside consultation; organizational ethics governs institutional policy, finance, and conduct affecting whole populations.
- **Four principles of biomedical ethics (Beauchamp and Childress)** vs **Belmont Report principles** — The four principles (autonomy, beneficence, non-maleficence, justice) frame clinical and organizational decisions; the Belmont Report's three principles (respect for persons, beneficence, justice) govern research on human subjects.
- **Stewardship and resource allocation** vs **Access** — Stewardship demands responsible use of finite resources and institutional solvency; access demands service to those who need care. The tension is managed by a fair, transparent allocation process, not dissolved.
...
1. **Which set of four principles did Beauchamp and Childress articulate as the standard framework of biomedical ethics?**
   - A. Beneficence, loyalty, obedience, and charity
   - B. Respect for autonomy, beneficence, non-maleficence, and justice
   - C. Confidentiality, consent, compliance, and cost control
   - D. Respect for persons, beneficence, and justice only

   **Answer: B.** In *Principles of Biomedical Ethics* (1979), Beauchamp and Childress named respect for autonomy, beneficence, non-maleficence, and justice. The three-part list in option D is the Belmont Report's, not their four principles, and the other options list concepts they did not frame as the four.

2. **A hospital CEO must decide how to award a multi-year laundry-services contract and how the savings should affect staffing across units. Which category of ethics does this decision primarily fall under?**
   - A. Organizational or administrative ethics
   - B. Clinical ethics
   - C. Research ethics under the Belmont Report
   - D. It raises no ethical question because it is a business matter

   **Answer: A.** A contract award and its effect on staffing across units is an institutional policy and finance decision affecting populations, which is organizational or administrative ethics. It is not a single-patient clinical decision, not human-subjects research, and business matters can still carry duties of stewardship, fairness, and avoiding conflicts of interest.

3. **A health system has fewer intensive-care beds than patients who could benefit. An administrator wants the allocation approach to be ethically defensible. Which principle is most directly at stake, and what does it require here?**
   - A. Autonomy, requiring each patient to choose their own bed
   - B. Non-maleficence, requiring the system to never discharge anyone
   - C. Justice, requiring a fair, transparent, consistent allocation process
   - D. Beneficence, requiring the most profitable patients be admitted first

   **Answer: C.** Distributing a scarce resource fairly is a question of justice, which calls for an allocation process that is fair, transparent, and consistent rather than ad hoc. Autonomy cannot create beds that do not exist, non-maleficence does not forbid all discharge, and prioritizing profit is not what beneficence means.

4. **What does the Belmont Report provide, and which principles does it name?**
   - A. A billing-compliance standard naming accuracy, timeliness, and completeness
   - B. A leadership competency model naming communication, business, and professionalism
   - C. A hospital accreditation manual naming safety, quality, and efficiency
   - D. A foundation for research ethics naming respect for persons, beneficence, and justice

   **Answer: D.** The Belmont Report (1979) sets out the ethical principles for research involving human subjects: respect for persons, beneficence, and justice, and it underlies institutional review boards. It is not a billing standard, a leadership competency model, or an accreditation manual.

5. **A vice president who sits on the board of a medical-device company is helping her hospital choose which company's devices to purchase. Ethically, what should happen, and why?**
   - A. Nothing, because holding two roles is always acceptable if both are legal
   - B. She should disclose the interest and, given its seriousness, recuse herself, because an undisclosed conflict of interest can bias a decision owed to patients and the organization
   - C. She should award the contract to her own company to reward loyalty
   - D. The decision should be hidden from the board to avoid embarrassment

   **Answer: B.** This is a conflict of interest: a personal stake could bias a purchasing decision owed to patients and the organization. The standard response is disclosure and, when the conflict is serious, recusal or avoidance. Legality alone does not resolve it, self-dealing violates fiduciary duty, and concealment defeats transparency.

## Sources

- *The Belmont Report: Ethical Principles and Guidelines for the Protection of Human Subjects of Research.* U.S. Department of Health and Human Services, Office for Human Research Protections (National Commission, 1979). https://www.hhs.gov/ohrp/regulations-and-policy/belmont-report/read-the-belmont-report/index.html (Public domain; full text read via an Internet Archive capture because hhs.gov blocked direct fetching.)
- *The Four Principles (Ethical Frameworks).* UK Clinical Ethics Network. https://ukcen.org/guidance-for-clinical-ethics-services/ethical-frameworks/four-principles/ (REFERENCE_ONLY) — attribution of the four principles to Beauchamp & Childress, *Principles of Biomedical Ethics* (1979), and their definitions.
- *ACHE Code of Ethics.* American College of Healthcare Executives (as amended Dec. 8, 2025). https://www.ache.org/about-ache/our-story/our-commitments/ethics/ache-code-of-ethics (REFERENCE_ONLY; copyrighted, described not reproduced.)
- Danis, M., Fox, E., Tarzian, A., & Duke, C. C. *Health care ethics programs in U.S. Hospitals: results from a national survey.* BMC Medical Ethics (2021), via PMC8320092. https://pmc.ncbi.nlm.nih.gov/articles/PMC8320092/ (CC BY 4.0) — prevalence and functions of hospital ethics programs.

## Related Topics

- health-administration:administration:healthcare-leadership
- health-administration:law-and-policy:health-policy
- health-administration:law-and-policy:patient-privacy
- health-administration:administration:organizational-culture
...
- **Rights status:** Public-domain government source (Belmont Report), one CC BY peer-reviewed article, and reference-only copyrighted sources (ACHE Code of Ethics, UKCEN). No ACHE or copyrighted standards text reproduced; frameworks attributed to Beauchamp & Childress and the Belmont Report.
- **Source count:** 4
