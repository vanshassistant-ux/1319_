...
- **Mistake:** Stating the 44,000-98,000 figure as a settled fact about how many people die from medical errors.
  **Correction:** It is the IOM's 2000 estimate, extrapolated from chart-review studies, and it has been debated ever since. Attribute it and call it an estimate, not a count.
- **Mistake:** Using "error" and "adverse event" as synonyms.
  **Correction:** An error is a wrong act that may cause no harm at all; an adverse event is actual harm from care. Many errors cause no adverse event, and some adverse events involve no error.
- **Mistake:** Believing a just culture means no one is ever blamed.
  **Correction:** A just culture is not blame-free. It holds a firm line for reckless behavior; it just refuses to punish honest error and bases its response on the behavior rather than on how bad the outcome was.
- **Mistake:** Treating the Swiss cheese model as a checklist for finding the one root cause to punish.
  **Correction:** The model shows that harm requires many aligned weaknesses across layers. Its point is to add and strengthen defenses, not to isolate a single person to blame.
- **Mistake:** Assuming a low count of reported events means a unit is safe.
  **Correction:** Voluntary reporting badly underestimates events, and near misses go unreported most of all. Few reports may signal a weak reporting culture, not a safe one.

## Compare / Contrast

- **Near miss vs. Adverse event:** In a near miss the patient was exposed to a hazard but escaped harm; in an adverse event the patient was actually harmed by care. Both expose the same system weaknesses.
- **Active failure vs. Latent condition:** An active failure is an unsafe act at the point of care with immediate effect; a latent condition is a dormant, upstream system weakness that made the act likely or consequential.
- **Punitive culture vs. Just culture:** A punitive culture disciplines individuals for bad outcomes and suppresses reporting; a just culture keeps a systems focus, responds to behavior type rather than outcome severity, and reserves sanction for reckless behavior.
...
**1. How should the "44,000 to 98,000 deaths per year" figure from *To Err Is Human* be characterized?**
- A. A precise, verified annual count of deaths from medical error
- B. The IOM's estimate, extrapolated from chart-review studies, whose magnitude has been debated
- C. A figure invented after the report to discredit hospitals
- D. The number of near misses recorded nationally each year

*Answer: B.* The 1999/2000 IOM report estimated 44,000-98,000 preventable hospital deaths per year by extrapolating from two chart-review studies, and that estimate has been contested ever since. It was never a precise verified count (A), it originated in the report rather than being invented to attack it (C), and it refers to deaths, not near misses (D).

**2. A pharmacist prepares the wrong dose but a barcode scanner catches it before the drug reaches the patient. What is this best called?**
- A. A near miss
- B. A preventable adverse event
- C. A sentinel event
- D. A never event

*Answer: A.* The patient was exposed to a hazard but escaped harm because a defense caught it, which is the definition of a near miss. A preventable adverse event (B) and a sentinel event (C) both require that harm actually reached the patient, and a never event (D) is a specific category of serious, clearly identifiable errors such as wrong-site surgery.

**3. In James Reason's framework, which is an example of a latent condition rather than an active failure?**
- A. A nurse misreading a label at the bedside
- B. A surgeon operating on the wrong site
- C. A technician mislabeling a specimen tube
- D. A pharmacy stocking two drugs in near-identical vials

*Answer: D.* Latent conditions are upstream system weaknesses created by earlier design and management decisions, such as stocking look-alike vials, that lie dormant until they enable an error. The other three are active failures - unsafe acts committed by people at the point of care with immediate effects.

**4. What most distinguishes a just culture from a blame-free ("no blame") culture?**
- A. A just culture punishes every error to deter future mistakes
- B. A just culture never assigns individual accountability under any circumstances
- C. A just culture keeps a systems focus but still holds individuals accountable for reckless behavior
- D. A just culture bases its response on how severe the patient's harm was

*Answer: C.* A just culture is a middle path: it treats most error as a system problem yet holds a firm line of accountability for reckless behavior, which a no-blame culture does not. It does not punish every error (A), it is not accountability-free (B), and it responds to the type of behavior rather than the severity of the outcome (D).

**5. Which statement about patient-safety event reporting systems is accurate?**
- A. Voluntary reporting captures nearly all events, so a low report count reliably means a safe unit
- B. Voluntary reporting undercounts events, and the 2005 Patient Safety and Quality Improvement Act created confidentiality protections to encourage reporting
- C. Federal law forbids hospitals from collecting near-miss reports
- D. Reporting a sentinel event replaces the need for any further investigation

*Answer: B.* Voluntary systems badly underreport events, and the Patient Safety and Quality Improvement Act of 2005 established Patient Safety Organizations with confidentiality and privilege protections to make reporting safer. A low count can signal weak reporting rather than safety (A); near-miss reporting is encouraged, not banned (C); and a sentinel event is expected to trigger a root cause analysis rather than end inquiry (D).

## Sources

- Institute of Medicine, *To Err Is Human: Building a Safer Health System* (released 1999; printed 2000), National Academies Press - https://nap.nationalacademies.org/catalog/9728/to-err-is-human-building-a-safer-health-system
- AHRQ Patient Safety Network, *Patient Safety 101* primer - https://psnet.ahrq.gov/primer/patient-safety-101
- AHRQ Patient Safety Network, *Never Events* primer - https://psnet.ahrq.gov/primer/never-events
- AHRQ Patient Safety Network, *Culture of Safety* primer - https://psnet.ahrq.gov/primer/culture-safety
- AHRQ Patient Safety Network, *High Reliability* primer - https://psnet.ahrq.gov/primer/high-reliability
- James Reason, "Human error: models and management," *BMJ* 2000;320:768-770 - https://pmc.ncbi.nlm.nih.gov/articles/PMC1117770/
- Stelfox et al., "The 'To Err is Human' report and the patient safety literature," *Qual Saf Health Care* - https://pmc.ncbi.nlm.nih.gov/articles/PMC2464859/

## Related Topics

- Root Cause Analysis (health-administration:quality-and-safety:root-cause-analysis)
- Healthcare Quality (health-administration:quality-and-safety:healthcare-quality)
- Quality Improvement (health-administration:quality-and-safety:quality-improvement)
- Organizational Culture (health-administration:administration:organizational-culture)
...
- **Rights status:** Reference-only sources; AHRQ (public-domain) primers and copyrighted IOM/BMJ works synthesized in original prose; no wording reproduced.
- **Transformation:** Facts from the IOM report and AHRQ PSNet primers were verified and rewritten as an original lesson; the *To Err Is Human* estimate is framed as an attributed, debated estimate; frameworks are attributed to Reason (Swiss cheese) and Marx (just culture); root cause analysis method and quality-improvement method are kept out of scope and handed off.
