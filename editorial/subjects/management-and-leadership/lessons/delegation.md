...
- **Chain of command:** The line of authority running from the top of an organization down through its levels, showing who reports to whom.
- **Empowerment:** Giving a person ownership and the authority to make decisions within their assigned work.
- **Dumping:** Offloading work without matching skills, giving instructions, providing support, or checking in — the failure mode that delegation is not.
...
1. **Delegating the task but keeping all the authority, so the person must ask permission for every decision.** Correction: Grant the authority the task requires, within agreed limits; otherwise you have assigned homework, not delegated.
2. **Delegating and disappearing — no check-in and no availability.** Correction: Schedule check-ins at sensible points and stay available for questions; checking in is oversight, not hovering.
3. **Dumping the undesirable work — handing every unpleasant task to whoever is closest, with no support.** Correction: Match the task to skills and development goals, explain it, and support it; dumping teaches people that delegation means getting the garbage.
4. **Overloading the most capable person because they never say no.** Correction: Spread the work; CFI warns that piling responsibilities beyond a person's capacity leads to burnout and worse performance.
5. **Snatching the task back at the first stumble.** Correction: Treat stumbles as coaching moments and keep the check-ins going; taking work back teaches people that effort is pointless — and the task boomerangs straight back onto your plate.

## Compare / Contrast

- **Delegation** versus **Dumping**: Delegation matches the task to the person, explains it, grants authority, and checks in; dumping offloads work without support or follow-through. Delegation keeps the accountability; dumping tries to leave it behind.
- **Responsibility** versus **Authority**: Responsibility is the task you are assigned; authority is the power to make the decisions the task requires. Delegation hands down both — keeping one without the other produces homework without the ability to finish it.
- **Delegating a task** versus **Abdicating it**: A delegator grants authority but keeps accountability and checks in; an abdicator walks away from the outcome entirely. That is the difference between handing work down with trust and letting it fall.
...
1. **According to the working definition in this lesson, what happens when a manager delegates?**
   ...
   - D. The manager reviews the employee's work after it is finished

   *Answer: A. The manager assigns some degree of authority and responsibility to another person to carry out the work — The working definition, attributed to OpenStax's Introduction to Business, is that managers delegate, or assign, some degree of authority and responsibility to others below them in the chain of command. Accountability stays with the manager, delegation moves the manager's tasks rather than the employee's job, and reviewing finished work is controlling, not delegating.*

2. **Maya, a store manager, hands the weekly supplier order to her assistant but tells her to get Maya's approval for every line item before placing it. Which element of delegation is missing from this handoff?**
   - A. Responsibility
   - B. Accountability
   - C. Authority
   - D. A deadline

   *Answer: C. Authority — Maya has assigned the task (responsibility) but kept the power to make the ordering decisions. Delegation requires granting authority — the power to complete the task — within agreed limits; without it, the assistant has homework that needs a signature at every step.*

3. **A team lead delegates the customer-refund process to a new hire, walks through the refund policy, and sets a fifteen-minute review for Friday afternoon. Which delegation step is the Friday meeting?**
   - A. Choosing the person
   - B. Explaining the task
   - C. Granting authority
   - D. Checking in

   *Answer: D. Checking in — The Friday meeting is the check-in: a scheduled point to review progress and answer questions. The lead chose the person and explained the task before the handoff, and authority was granted when the task was assigned — the review is the follow-through.*

4. **A manager delegates a data-entry cleanup to an intern, gives no instructions, and never mentions it again until the report is due. The intern delivers it late and full of errors. Who is accountable to the manager's own boss for the late report?**
   - A. The manager
   - B. The intern
   - C. The intern's coworkers
   - D. No one, because the work was delegated

   *Answer: A. The manager — Accountability moves upward: the manager remains responsible for outcomes of work done by people below them. The manager also skipped the explain and check-in steps — but even so, the final accountability for the report sits with the manager, not the intern.*

5. **A department head wants to free up time. Which of the following is an example of delegating rather than dumping?**
   - A. Handing every undesirable task to whichever employee is closest
   - B. Giving a capable employee a routine reporting task with clear instructions, a deadline, and a weekly check-in
   - C. Assigning a task the employee lacks the skills and resources to complete
   - D. Telling an employee to handle something without saying what done looks like

   *Answer: B. Giving a capable employee a routine reporting task with clear instructions, a deadline, and a weekly check-in — Delegation matches the task to the person, explains the expected result, provides support, and checks in — the second option does all four. The other options are dumping: no matching, no support, and no clarity, which CFI lists among delegation's failure modes.*

## Sources

- OpenStax, Rice University. *Introduction to Business*, Section 7.4: Authority—Establishing Organizational Relationships. https://openstax.org/books/introduction-business/pages/7-4-authority-establishing-organizational-relationships (CC BY 4.0)
- Corporate Finance Institute. *Delegating*. https://corporatefinanceinstitute.com/resources/management/delegating/
...
- Management and Leadership: Performance Management
- Management and Leadership: Management Versus Leadership

## Editorial Metadata

- Topic ID: management-and-leadership:foundations:delegation
- Subject: management-and-leadership (Foundations)
- Editorial status: READY_TO_PUBLISH
- Researched at: 2026-08-22
- Research status: source-verified
- Rights: OpenStax Introduction to Business section 7.4 used as reference (CC BY 4.0; openstax.org blocks direct fetching, so the section was read via a Wayback Machine capture and its content paraphrased into original prose, with the one-sentence working definition quoted with attribution); CFI's Delegating page used as reference-only; no other source prose reproduced