...
Negotiation is a discussion aimed at reaching an agreement — the back-and-forth that happens when two sides share some interests and oppose others. It shows up when salaries are offered, contracts are signed, conflicts are settled, and purchases are made. Skilled negotiators prepare a target and a walk-away point, look past positions to the interests underneath, and aim for a deal both sides can live with.
...
- **Negotiation** — A discussion between two or more sides aimed at reaching an agreement, where each side has some interests it shares with the other and some it opposes.
- **Position** — What a side says it wants in a negotiation — its stated demand, such as a specific price or a delivery date.
- **Interest** — The underlying need, worry, or goal that a position is meant to protect or satisfy.
- **Distributive negotiation** — Bargaining over a fixed amount of value, where any gain for one side is a loss for the other.
- **Integrative negotiation** — Bargaining that looks for ways to create additional value so both sides can come out ahead.
- **BATNA** — Best alternative to a negotiated agreement; the fallback you can take if talks fail, and the floor beneath your walk-away point.
- **Walk-away point** — The least favorable deal you will accept before choosing your alternative instead.
...
- **Mistake:** Digging in on your position — my price or nothing — and treating the other side's demand as the enemy.
  **Correction:** A position is just the surface. Ask what need your demand and their demand are each protecting; interests can often both be satisfied.
- **Mistake:** Treating every negotiation as a fixed pie, assuming your gain must be their loss.
  **Correction:** Check for integrative moves first — different priorities can create value for both sides. If the pie is truly fixed, then divide it, but know you are in a distributive negotiation.
- **Mistake:** Walking in without a walk-away point, then accepting a bad deal out of fear of losing the conversation.
  **Correction:** Name your BATNA before you start. Knowing your fallback tells you when to accept and when to walk.
- **Mistake:** Celebrating a one-sided win and calling the negotiation over.
  **Correction:** A deal the other side cannot live with tends to fall apart later — they stop honoring it, and the win evaporates. Aim for terms both sides can keep.

## Compare / Contrast

- **Position** versus **Interest**: A position is what a side says it wants; the interest is the underlying need the demand protects. Two opposite positions — window open versus window shut — can sit on top of interests that are both satisfiable.
- **Distributive negotiation** versus **Integrative negotiation**: Distributive bargaining divides a fixed pie, so one side's gain is the other's loss; integrative bargaining tries to grow the pie so both sides can win. Real negotiations often mix the two.
- **Negotiation** versus **Conflict resolution**: Negotiation is the give-and-take of reaching an agreement between sides with partly shared and partly opposed interests; conflict resolution is the broader field of settling disagreements peacefully, of which negotiation is one tool (covered in its own lesson).
...
- Back-and-forth communication designed to reach an agreement when the sides share some interests and oppose others
- A formal vote in which the majority's choice binds everyone
- A one-sided decision handed down by whoever holds more authority
- A private conversation with no goal beyond exchanging information

**Answer:** Back-and-forth communication designed to reach an agreement when the sides share some interests and oppose others

**Why:** The Getting to Yes definition, quoted by the Program on Negotiation, describes negotiation as back-and-forth communication designed to reach an agreement when the sides have some shared and some opposed interests. A vote, a command, and a goal-free chat each miss the give-and-take toward agreement.

*Difficulty: recall · Skill: Recalling the attributed working definition of negotiation*
...
- Arriving by 6 a.m. sharp
- Protecting the fragile pastries from traffic damage
- Reducing the bakery's opening hours
- Charging a higher delivery fee

**Answer:** Protecting the fragile pastries from traffic damage

**Why:** An interest is the underlying need behind a position. The driver's need is that the pastries arrive undamaged; the 6 a.m. time is the bakery's stated demand. Loading the van the night before meets both the driver's interest and the bakery's deadline.

*Difficulty: application · Skill: Applying the positions-versus-interests distinction to a delivery dispute*
...
**Why:** CFI describes distributive negotiation as hard bargaining over a fixed amount: any gain for one side comes at the other's expense, as when one truck's win is the other's loss. Integrative negotiation would look for a way both trucks could benefit, such as sharing the spot.

*Difficulty: analysis · Skill: Identifying distributive negotiation in a fixed-pie scenario*

### Question 4

Before meeting the seller, Nina lines up a second client who will pay her usual rate if the current deal falls through. The second client is Nina's —

- Opening position
- Target point
- Integrative option
- BATNA — her best alternative to a negotiated agreement

**Answer:** BATNA — her best alternative to a negotiated agreement

**Why:** A BATNA is the best alternative to a negotiated agreement — what you will do if talks fail. Fisher, Ury, and Patton call a strong BATNA a negotiator's greatest source of power. Nina's second client is her fallback, not her position or her target.

*Difficulty: application · Skill: Applying the BATNA concept to a preparation scenario*

### Question 5

Two neighbors split the cost of a shared fence, and one negotiates hard enough to make the other pay for everything. The loser stops maintaining their side, and within two years the fence rots and must be replaced — costing both neighbors more than the original deal. What does this outcome show?

- The best deal is one both sides can live with, because a resentful loser quietly undermines it
- Hard bargaining is always the most efficient way to settle a fence dispute
- Fence maintenance is a separate conflict and cannot be negotiated
- A one-sided win is the sign of a well-negotiated agreement

**Answer:** The best deal is one both sides can live with, because a resentful loser quietly undermines it

**Why:** CFI warns that a negotiator who only takes and never gives creates hostility and is less likely to keep the outcome, and OPM frames negotiating as building consensus through give and take. The fence collapsed because one side could not live with the deal — durable agreements need both sides able to say yes and mean it.

*Difficulty: analysis · Skill: Analyzing why a one-sided deal fails the both-sides-can-live-with test*

## Sources

- pon-what-is-negotiation
- pon-principled-negotiation-interests
- pon-batna-beyond-the-basics
- cfi-negotiation
- cfi-negotiation-tactics
- opm-ses-qualifications-guide
...
- Topic id: management-and-leadership:foundations:negotiation
- Phase: 2
- Subject: management-and-leadership
- Editorial status: READY_TO_PUBLISH
- Research date: 2026-08-22
- Sources are reference-only (OPM guide is a public-domain U.S. government work); facts restated in original prose.