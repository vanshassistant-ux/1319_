...
*EliExplains lesson - Social Work & Human Services / Ethics. Educational material about how U.S. confidentiality rules are structured. Not legal advice.*

## In 30 Seconds

Confidentiality is the practitioner's duty over what a client discloses inside a professional relationship. Privacy is the client's own interest in controlling information about themselves. Privilege is a narrower evidence rule about what a court can compel. In the United States, HIPAA binds only covered entities and their business associates, substance use disorder treatment records carry stricter federal protection, and every duty has limits set largely by state law. Naming those limits out loud, at the start, is the practice standard.
...
- **protected health information** - Individually identifiable health data held or transmitted in any form by a HIPAA covered entity or business associate, excluding FERPA education records, employment records held by an employer, and information about people dead more than 50 years.
- **covered entity** - A health plan, a health care clearinghouse, or a health care provider that transmits health information electronically in connection with a transaction the HIPAA rules cover.
- **business associate** - A person or organization outside a covered entity's workforce that handles protected health information on that entity's behalf, or supplies listed professional services requiring access to it; subcontractors are included.
- **minimum necessary standard** - The requirement to make reasonable efforts to limit the health information used, disclosed, or requested to what the stated purpose actually needs, subject to listed exceptions such as treatment disclosures.
- **authorization** - A signed, plain-language document meeting specified regulatory elements that permits a described disclosure to a named recipient for a stated purpose, with an expiration and a right to revoke.
- **part 2 program** - A federally assisted individual or organization that holds itself out as providing, and does provide, substance use disorder diagnosis, treatment, or referral for treatment.
- **redisclosure** - Further sharing of information by a recipient after it has left the original holder, at which point the original federal protections may no longer travel with it.
- **mandated reporter** - A person whom state law obligates to notify authorities upon suspecting, in their official capacity, that a child or other protected person is being abused or neglected.
- **duty to protect** - A state-law obligation, arising from the Tarasoff line of cases or from statute, to take reasonable steps to prevent foreseeable serious harm to an identifiable person.
- **privilege** - An evidence rule that lets a client keep a court from compelling a professional to testify about, or produce records of, their confidential communications.
...
**Where the analogy breaks down.** The bike breaks the picture in two places. Information is not a bike. Once you tell someone, you cannot get it back, and copies can sit in a chart, a billing system, and an email at the same time, each with different protection. The second break is the fire-station rule. Your friend deciding about a burning bike is deciding alone, in a moment. A practitioner is following rules that other people wrote down, that differ from state to state, and that specialists still argue about at the edges.
...
| | | Distinction |
| --- | --- | --- |
| **Privacy** | **Confidentiality** | Privacy is the client's interest in controlling information about themselves and exists independently of any professional. Confidentiality is a duty that attaches to the practitioner and the agency once information is disclosed inside a professional relationship. |
| **Confidentiality** | **Privilege** | Confidentiality is an ethical and regulatory duty about what you may share in practice. Privilege is an evidence rule about what a court may compel. Jaffee v. Redmond (1996) recognized a federal psychotherapist-patient privilege reaching licensed clinical social workers, but much information is confidential without being privileged, and state reporting statutes commonly restrict privilege for mandated reporters. |
| **Consent for treatment, payment, and health care operations** | **Authorization** | Section 164.506 permits a covered entity to use and disclose protected health information for treatment, payment, and health care operations without a signed authorization. Section 164.508 requires an authorization with specified core elements and notice statements for disclosures outside those permissions. |
| **HIPAA Privacy Rule** | **42 CFR Part 2** | HIPAA sets a federal floor for protected health information held by covered entities and business associates. Part 2 adds stricter, program-based protection to records from federally assisted substance use disorder programs, including a bar on using records or related testimony against the patient in legal proceedings without specific consent or a qualifying court order. |
| **Duty to warn** | **Duty to protect** | The 1974 Tarasoff decision framed a duty to warn a foreseeable victim. The 1976 rehearing framed a broader duty to exercise reasonable care to protect, of which warning is one possible step among several. States adopted these formulations unevenly, by statute, by common law, or not at all. |
| **Subpoena** | **Court order** | A subpoena is a party's demand for records or testimony; a court order is a judicial directive. HIPAA lets a covered entity respond directly to an order but conditions response to a bare subpoena on notice or a protective order, and Part 2 requires a qualifying court order regardless of any subpoena. |
...
**1. Under 45 CFR 160.102, the HIPAA rules apply directly to which set of entities?**

   A. Any organization in the United States that stores or transmits health information about an identifiable person.
   B. Health plans, health care clearinghouses, health care providers who transmit health information electronically in connection with a covered transaction, and - where specified - their business associates.
   C. All licensed health and behavioral health professionals, regardless of how they transmit information.
   D. Federal and state government agencies that fund or license health care services.

   *Answer: B.* Section 160.102 names health plans, health care clearinghouses, and providers who transmit electronically for covered transactions, and applies specified requirements to business associates. Merely holding health information does not make an organization covered; licensure alone is not the test, since the trigger is electronic transmission for a covered transaction; and funding or licensing health care does not bring an agency inside the rules.
   *Difficulty: recall - Identifying the scope of HIPAA's applicability. Sources: ecfr-45-cfr-160-hipaa-general-provisions.*

**2. A client's statement in a counseling session is confidential, yet a state mandated-reporting statute removes the professional's ability to withhold it when child abuse is suspected. Which distinction does this best illustrate?**

   A. Privilege is broader than confidentiality, so privilege overrides state reporting statutes.
   B. Privacy and confidentiality are synonyms, so a limit on one automatically removes the other.
   C. Confidentiality is the practitioner's practice duty, while privilege is a separate evidentiary rule that state reporting laws commonly restrict for mandated reporters.
   D. Because HIPAA permits a disclosure required by law, state confidentiality law no longer applies at all.

   *Answer: C.* Confidentiality is the duty attaching to information disclosed in a professional relationship; privilege is an evidence rule about compelled testimony and records, and most states restrict it for mandated reporters. Privilege is narrower than confidentiality, not broader. Privacy is the client's own interest in controlling information and is not a synonym for the practitioner's duty. And 45 CFR 160.203 preserves more stringent state privacy law rather than displacing it.
   *Difficulty: understanding - Distinguishing privacy, confidentiality, and privilege. Sources: cwig-mandatory-reporting-state-statutes-2023, jaffee-v-redmond-518-us-1-1996, ecfr-45-cfr-160-hipaa-general-provisions.*

**3. A covered entity receives two requests for a client's records: one from its own billing department to process a claim, and one from a treating physician to guide care. How does HIPAA's minimum necessary standard apply?**

   A. It applies to both requests identically, because both involve protected health information.
   B. It applies to the payment-related use, but not to a disclosure to, or a request by, a health care provider for treatment.
   C. It applies to neither, because both fall under treatment, payment, and health care operations.
   D. It applies only after the client has signed an authorization for the disclosure.

   *Answer: B.* Section 164.502(b) requires reasonable efforts to limit information to the minimum necessary, and 164.502(b)(2)(i) excepts disclosures to, or requests by, a health care provider for treatment. Payment activities carry no such exception. Being a treatment, payment, or health care operations activity does not by itself exempt a use, and uses made under an authorization are actually excepted by 164.502(b)(2)(iii), which reverses the last option.
   *Difficulty: application - Applying the minimum necessary standard and its exceptions. Sources: ecfr-45-cfr-164-subpart-e-privacy-rule.*

**4. Which statement most accurately characterizes duty-to-protect obligations in the United States after the Tarasoff decisions?**

   A. Tarasoff established a uniform federal duty binding practitioners in every state and territory.
   B. HIPAA's serious-threat provision creates the duty and defines when a practitioner must warn a third party.
   C. The obligations are state-law doctrines that vary: some states impose a mandatory duty by statute, some by common law, some permit disclosure without requiring it, and some offer no guidance.
   D. The 1976 rehearing narrowed the obligation so that warning an identified victim is now the only permitted response.

   *Answer: C.* Tarasoff is California case law, and the 1976 rehearing broadened the 1974 duty to warn into a duty to exercise reasonable care to protect - so the last option inverts the holding. A 2014 review summarizing a 2012 classification counted 23 states with a statutory mandatory duty, 10 with a common-law duty, 11 permitting disclosure without requiring it, and 6 with no guidance, which rules out any uniform federal duty. HIPAA's 45 CFR 164.512(j) permits a good-faith disclosure to avert a serious and imminent threat but does not itself create an obligation to act.
   *Difficulty: analysis - Evaluating the jurisdictional scope of duty-to-protect doctrine. Sources: jaapl-2014-tarasoff-interstate-variation, ecfr-45-cfr-164-subpart-e-privacy-rule.*

**5. What did the 2024 final rule implementing CARES Act section 3221 change for substance use disorder treatment records under 42 CFR Part 2?**

   A. Part 2 was repealed, and those records are now governed solely by the HIPAA Privacy Rule.
   B. A patient may give a single written consent covering all future treatment, payment, and health care operations disclosures, and HIPAA breach notification and penalty provisions now apply, while the bar on using records against the patient in legal proceedings remains.
   C. Part 2 now reaches every provider who documents a substance use disorder, whether or not the provider is federally assisted.
   D. Court orders are no longer needed, because a subpoena is now sufficient to compel release of Part 2 records.

   *Answer: B.* The rule at 89 FR 12472, effective April 16, 2024 with a compliance date of February 16, 2026, added the single treatment-payment-operations consent at 42 CFR 2.31(a), applied HIPAA breach notification at 2.16(b) and HIPAA penalties at 2.3, and left intact the restrictions at 2.12(d)(1) and 2.13(a) on using records against the patient. Part 2 was not repealed; it remains program-based rather than diagnosis-based under 2.12(e)(2); and 2.13(b) still provides that a subpoena alone does not permit disclosure.
   *Difficulty: understanding - Explaining the current state of 42 CFR Part 2 and the 2024 alignment rule. Sources: fr-2024-42-cfr-part-2-final-rule, ecfr-42-cfr-part-2-sud-records.*

## Sources

- **45 CFR Part 160 - General Administrative Requirements (HIPAA applicability, definitions, and preemption)** - U.S. Government Publishing Office / Office of the Federal Register (eCFR). <https://www.ecfr.gov/current/title-45/subtitle-A/subchapter-C/part-160> (`ecfr-45-cfr-160-hipaa-general-provisions`, government, usage: PUBLIC_DOMAIN, checked 2026-08-18)
- **45 CFR Part 164 Subpart E - Privacy of Individually Identifiable Health Information** - U.S. Government Publishing Office / Office of the Federal Register (eCFR). <https://www.ecfr.gov/current/title-45/subtitle-A/subchapter-C/part-164/subpart-E> (`ecfr-45-cfr-164-subpart-e-privacy-rule`, government, usage: PUBLIC_DOMAIN, checked 2026-08-18)
- **42 CFR Part 2 - Confidentiality of Substance Use Disorder Patient Records** - U.S. Government Publishing Office / Office of the Federal Register (eCFR). <https://www.ecfr.gov/current/title-42/chapter-I/subchapter-A/part-2> (`ecfr-42-cfr-part-2-sud-records`, government, usage: PUBLIC_DOMAIN, checked 2026-08-18)
- **Confidentiality of Substance Use Disorder (SUD) Patient Records; Final Rule, 89 FR 12472** - U.S. Department of Health and Human Services (Office for Civil Rights and SAMHSA), via the Federal Register. <https://www.federalregister.gov/documents/2024/02/16/2024-02544/confidentiality-of-substance-use-disorder-sud-patient-records> (`fr-2024-42-cfr-part-2-final-rule`, government, usage: PUBLIC_DOMAIN, checked 2026-08-18)
- **34 CFR Part 99 - Family Educational Rights and Privacy** - U.S. Government Publishing Office / Office of the Federal Register (eCFR). <https://www.ecfr.gov/current/title-34/subtitle-A/part-99> (`ecfr-34-cfr-part-99-ferpa`, government, usage: PUBLIC_DOMAIN, checked 2026-08-18)
- **Mandatory Reporting of Child Abuse and Neglect (State Statutes, current through May 2023)** - Child Welfare Information Gateway, Children's Bureau, Administration for Children and Families, U.S. Department of Health and Human Services. <https://www.childwelfare.gov/resources/mandatory-reporting-child-abuse-and-neglect/> (`cwig-mandatory-reporting-state-statutes-2023`, government, usage: PUBLIC_DOMAIN, checked 2026-08-18)
- **The Tarasoff Rule: The Implications of Interstate Variation and Gaps in Professional Training** - Journal of the American Academy of Psychiatry and the Law (Johnson R, Persad G, Sisti D; 2014;42(4):469-477). <https://jaapl.org/content/42/4/469> (`jaapl-2014-tarasoff-interstate-variation`, peer-reviewed, usage: REFERENCE_ONLY, checked 2026-08-18)
- **Jaffee v. Redmond, 518 U.S. 1 (1996)** - Legal Information Institute, Cornell Law School. <https://www.law.cornell.edu/supremecourt/text/518/1> (`jaffee-v-redmond-518-us-1-1996`, reference, usage: REFERENCE_ONLY, checked 2026-08-18)
- **NASW Code of Ethics (2021 revision), Standard 1.07 Privacy and Confidentiality** - National Association of Social Workers. <https://www.socialworkers.org/About/Ethics/Code-of-Ethics/Code-of-Ethics-English> (`nasw-code-of-ethics-2021`, standards-body, usage: REFERENCE_ONLY, checked 2026-08-18)

## Related Topics

- `social-work-and-human-services:ethics:ethics-in-helping-professions`
- `social-work-and-human-services:ethics:professional-boundaries`
- `social-work-and-human-services:case-management:what-case-management-is`

The parallel topic `ethics-in-helping-professions` owns professional codes, core values, and structured ethical decision-making. The parallel topic `professional-boundaries` owns dual relationships and role boundaries. Neither is duplicated here.

## Editorial Metadata

- **Topic id:** `social-work-and-human-services:ethics:confidentiality-and-privacy`
- **Editorial status:** READY_TO_PUBLISH
- **Estimated minutes:** 14
- **Researched at:** 2026-08-18
- **Review profile:** legal, health-adjacent, ethics
- **Source count:** 9; **questions:** 5
- **Rights status:** Regulatory and case text read directly from eCFR, the Federal Register, and Cornell LII; U.S. federal regulations are edicts of government and not copyrightable, and no regulatory prose was reproduced beyond short defined terms. The NASW Code of Ethics and the JAAPL article are reference-only; their standards and findings are described in original wording and never quoted.
- **Transformation:** All prose written from primary regulatory text (45 CFR Parts 160 and 164, 42 CFR Part 2, 34 CFR Part 99), the 2024 Part 2 final rule preamble, a federal Supreme Court opinion, a federal agency statutory review, and one peer-reviewed review article. The machine-generated draft supplied no substantive content and was discarded entirely.
- **Legal notice:** Educational material about the structure of U.S. federal and state confidentiality law. Not legal advice, and not guidance for any actual disclosure decision. State law varies and is often stricter.
