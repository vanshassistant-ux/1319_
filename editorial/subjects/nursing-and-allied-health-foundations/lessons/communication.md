...
Verbal communication is the words: what is said and how precisely. Nonverbal communication is everything that carries meaning alongside the words — tone, body language, and silence. Tone: the same sentence can reassure or alarm depending on delivery. Body language: a caregiver who turns toward the patient and sits at eye level communicates attention; one who stands at the door with crossed arms communicates hurry. Silence communicates too: a patient who goes quiet mid-explanation may be processing, worried, or afraid to ask. Skilled communicators read silence as information and make room for it.
...
- **communication (in healthcare)** — The exchange of information between patients, families, and the care team.
- **verbal communication** — The words used to convey information.
- **nonverbal communication** — Meaning carried without words: tone of voice, body language, and silence.
- **active listening** — Giving full attention to the speaker and checking that you understood correctly.
- **teach-back** — Asking the patient or family member to explain key information back in their own words to confirm understanding.
- **handoff** — The transfer of information and responsibility for a patient from one caregiver to another, as at a shift change.
- **SBAR** — A TeamSTEPPS structure for communicating critical information: Situation, Background, Assessment, Recommendation.
- **closed-loop communication** — Confirming that a message was received and understood, so information does not die in transit.
- **jargon** — Technical or medical language that people outside the field do not understand.
- **barrier** — Anything that blocks or distorts the exchange of information, such as a language difference, hearing loss, anxiety, or jargon.
...
- **"Nodding means the patient understood."** People nod to be polite or to end the conversation. Teach-back — asking the patient to explain the key points in their own words — is the reliable check.
- **"Talking louder fixes a language barrier."** Volume does not create understanding. Slow down, use plain words, check understanding, and involve an interpreter when the patient and caregiver do not share a language.
- **"A handoff is just chatting about the shift."** A handoff transfers information and responsibility. A detail skipped at shift change can mean the next caregiver never looks for a problem.
- **"Medical words show professionalism."** To the patient they are a wall. AHRQ's guidance is blunt: using terms patients do not understand excludes them from their own care. Plain words are the professional choice.
- **"Silence means nothing is being communicated."** Silence communicates: worry, confusion, disagreement, or a mind racing to understand. Skilled communicators notice silence and make room for it.

## Compare / Contrast

- **Verbal vs. nonverbal communication:** Verbal is the words; nonverbal is tone, body language, and silence. They usually agree, and when they do not — the words say "everything is fine" while the tone says otherwise — people believe the nonverbal.
- **Teach-back vs. "Do you understand?":** "Do you understand?" invites a yes. Teach-back asks the person to restate the information, which reveals what was actually heard.
- **SBAR vs. free-form report:** A free-form report follows memory and habit, so it skips whatever the speaker forgets. SBAR follows a fixed order — Situation, Background, Assessment, Recommendation — so the critical pieces are harder to drop.
...
1. **A nurse calls a physician about a patient whose condition changed overnight. She says: "Dr. Patel, this is Marcus on 3 East. Mr. Ito's blood pressure dropped to 85/50 an hour ago and he's lightheaded. He's two days past surgery. I'm concerned about bleeding, and I'd like you to see him." Which technique is she using?**
   - Teach-back — she is checking the physician's understanding of the patient's story.
   - SBAR — she leads with the situation, then background, assessment, and recommendation.
   - Active listening — she repeats what the physician told her.
   - A handoff — she is transferring the patient to the physician's care.
   - **Correct:** B — The nurse follows the SBAR structure from AHRQ's TeamSTEPPS: Situation (blood pressure drop, lightheadedness), Background (two days post-surgery), Assessment (concern about bleeding), Recommendation (come see the patient). Teach-back checks understanding by asking the listener to restate information; active listening means attending to what another person says; and a handoff transfers responsibility for the patient, which this call does not.

2. **After explaining a new medication schedule, a nurse wants to confirm the patient really understood. Which action is the teach-back method?**
   - Asking "Do you understand?"
   - Repeating the instructions more slowly.
   - Writing the schedule down and leaving it at the bedside.
   - Asking the patient to explain the schedule back in their own words.
   - **Correct:** D — Teach-back, as AHRQ describes it, is checking understanding by asking patients to state in their own words what they need to know or do. A yes-or-no "Do you understand?" invites agreement without evidence, and slowing down or leaving a written schedule helps but does not check what was actually heard.

3. **A patient who speaks limited English nods throughout a nurse's explanation of after-surgery care. Which response best keeps the information moving?**
   - Use plain language, keep the points few, and check understanding by asking the patient to explain the key steps back — with an interpreter involved.
   - Speak a little louder and take the nodding as agreement.
   - End the conversation quickly so the patient is not embarrassed.
   - Give the patient a printed page with the instructions in English.
   - **Correct:** A — A language difference is a known barrier, and the fix is structure, not volume: plain words, few key points, teach-back, and an interpreter when patient and caregiver do not share a language. Volume does not create understanding, nodding is not evidence of understanding, and an English-only handout repeats the problem in writing.

4. **What is a handoff in healthcare?**
   - A brief check-in where the current team aligns on what is happening before acting.
   - A written record of everything that happened during a shift.
   - The transfer of information and responsibility for a patient from one caregiver to another, such as at a shift change.
   - A technique for communicating critical information that needs immediate attention.
   - **Correct:** C — AHRQ's PSNet primer defines a handoff as one provider updating another on a patient's status for the purpose of handing over responsibility for their care. A check-in with the current team is a huddle, a written shift record is documentation, and the critical-information technique is SBAR.

5. **During a conversation, a nurse stands with crossed arms, glances at her watch, and interrupts the patient mid-sentence. The patient stops and says, "Never mind." What best explains what happened?**
   - The patient was too tired to continue the conversation.
   - The nurse's posture and interruptions signaled that she was not listening, so the patient stopped sharing information.
   - The patient did not know the answer to the nurse's question.
   - The nurse's questions were too difficult to understand.
   - **Correct:** B — Nonverbal communication — posture, eye contact, and interruptions — carries meaning alongside words. Crossed arms, watch-glancing, and interrupting signal hurry and inattention, and patients respond by withholding information. Silence and body language communicate; skilled communicators notice what their own body is saying.

## Sources

- AHRQ — TeamSTEPPS Program: https://www.ahrq.gov/teamstepps-program/index.html
- AHRQ — TeamSTEPPS 3.0 Pocket Guide: https://www.ahrq.gov/sites/default/files/wysiwyg/teamstepps-program/teamstepps-pocket-guide.pdf
- AHRQ PSNet — Handoffs and Signouts: https://psnet.ahrq.gov/primer/handoffs-and-signouts
- AHRQ — Health Literacy Universal Precautions Toolkit: https://www.ahrq.gov/health-literacy/improve/precautions/toolkit.html
- AHRQ — Health Literacy Toolkit, Tool 5 (Teach-Back): https://www.ahrq.gov/health-literacy/improve/precautions/tool5.html
...
- nursing-and-allied-health-foundations:foundations:therapeutic-communication
...
- Rights status: reference-only U.S. government sources (AHRQ, MedlinePlus/NLM); facts synthesized, no source prose adapted
